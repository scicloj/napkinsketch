...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species})
    (sk/xkcd7-options {:title "Iris Sepal Measurements"
                       :x-label "Length (cm)"
                       :y-label "Width (cm)"}))
...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species})
    (sk/xkcd7-options {:title "Iris Measurements"
...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species :alpha 0.5 :size 5}))
...
(-> data/iris
    (sk/xkcd7-lay-bar :species {:alpha 0.4}))
...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species})
    (sk/xkcd7-annotate (sk/band-v 5.5 6.5) (sk/band-h 3.0 3.5 {:alpha 0.3})))
...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species})
    (sk/xkcd7-options {:palette {:setosa "#E74C3C"
                                 :versicolor "#3498DB"
                                 :virginica "#2ECC71"}}))
...
(-> data/iris
    (sk/xkcd7-lay-point :sepal_length :sepal_width {:color :species})
    (sk/xkcd7-options {:title "White Theme"
...
(kind/test-last [(fn [v] (= :div (first (sk/xkcd7-plot v))))])
