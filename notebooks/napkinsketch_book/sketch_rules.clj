...
;; ```
;;
;; Later maps win. `nil` values cancel earlier keys. The mark and stat
;; are determined by the `sk/lay-*` function you chose (e.g., `lay-point`
;; sets mark to `:point`, `lay-lm` sets mark to `:line` with stat `:lm`).
;;
;; ## Verb Rules
;;
