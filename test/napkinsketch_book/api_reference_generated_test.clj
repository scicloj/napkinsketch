 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__81410#] (Math/sin (* p1__81410# 0.3)))
     (range 30))})))
  ...
  (tc/dataset
   {:x (vec (concat (range 30) (range 30))),
    ...
    (vec
     (concat
      (mapv
       (fn* [p1__81411#] (Math/sin (* p1__81411# 0.3)))
       (range 30))
      (mapv
       (fn* [p1__81412#] (Math/cos (* p1__81412# 0.3)))
       (range 30)))),
 ...
 (->
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__81414#] (Math/sin (* p1__81414# 0.3)))
     (range 30))})
  (sk/view [[:x :y]])
  (sk/lay (sk/area))
  sk/plot))
