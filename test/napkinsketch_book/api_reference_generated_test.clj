 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__457958#] (Math/sin (* p1__457958# 0.3)))
     (range 30))})))
  ...
  (tc/dataset
   {:x (vec (concat (range 30) (range 30))),
    ...
    (vec
     (concat
      (mapv
       (fn* [p1__457959#] (Math/sin (* p1__457959# 0.3)))
       (range 30))
      (mapv
       (fn* [p1__457960#] (Math/cos (* p1__457960# 0.3)))
       (range 30)))),
  ...
  (tc/dataset
   {:x (range 50),
    ...
    (mapv
     (fn*
      [p1__457961#]
      (+ (Math/sin (* p1__457961# 0.2)) (* 0.3 (- (rand) 0.5))))
     (range 50))})))
 ...
 (->
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__457962#] (Math/sin (* p1__457962# 0.3)))
     (range 30))})
  (sk/view [[:x :y]])
  (sk/lay (sk/area))
  sk/plot))
