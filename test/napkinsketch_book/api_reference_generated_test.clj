 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__247865#] (Math/sin (* p1__247865# 0.3)))
     (range 30))})))
  ...
  (tc/dataset
   {:x (vec (concat (range 30) (range 30))),
    ...
    (vec
     (concat
      (mapv
       (fn* [p1__247866#] (Math/sin (* p1__247866# 0.3)))
       (range 30))
      (mapv
       (fn* [p1__247867#] (Math/cos (* p1__247867# 0.3)))
       (range 30)))),
 ...
 (->
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__247869#] (Math/sin (* p1__247869# 0.3)))
     (range 30))})
  (sk/view [[:x :y]])
  (sk/lay (sk/area))
  sk/plot))
