 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__90778#] (Math/sin (* p1__90778# 0.3)))
     (range 30))})))
  ...
  (tc/dataset
   {:x (vec (concat (range 30) (range 30))),
    ...
    (vec
     (concat
      (mapv
       (fn* [p1__90779#] (Math/sin (* p1__90779# 0.3)))
       (range 30))
      (mapv
       (fn* [p1__90780#] (Math/cos (* p1__90780# 0.3)))
       (range 30)))),
 ...
 (->
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__90782#] (Math/sin (* p1__90782# 0.3)))
     (range 30))})
  (sk/view [[:x :y]])
  (sk/lay (sk/area))
  sk/plot))
