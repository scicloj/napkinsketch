 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__74184#] (Math/sin (* p1__74184# 0.3)))
     (range 30))})))
  ...
  (tc/dataset
   {:x (vec (concat (range 30) (range 30))),
    ...
    (vec
     (concat
      (mapv
       (fn* [p1__74185#] (Math/sin (* p1__74185# 0.3)))
       (range 30))
      (mapv
       (fn* [p1__74186#] (Math/cos (* p1__74186# 0.3)))
       (range 30)))),
  ...
  (tc/dataset
   {:x (range 50),
    ...
    (mapv
     (fn*
      [p1__74187#]
      (+ (Math/sin (* p1__74187# 0.2)) (* 0.3 (- (rand) 0.5))))
     (range 50))})))
 ...
 (->
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__74188#] (Math/sin (* p1__74188# 0.3)))
     (range 30))})
  (sk/view [[:x :y]])
  (sk/lay (sk/area))
  sk/plot))
