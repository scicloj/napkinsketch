...
(def v20_l126 (def trace-views (sketch-impl/resolve-sketch trace-sk)))


(def v21_l129 (count trace-views))


(deftest t22_l131 (is ((fn [n] (= 1 n)) v21_l129)))


(def v23_l133 (select-keys (first trace-views) [:x :y :mark :color]))
...
(def v26_l146 (def trace-plan (plan-impl/views->plan trace-views {})))
...
(def v57_l284 (def multi-views (sketch-impl/resolve-sketch multi-sk)))


(def v58_l286 (count multi-views))


(deftest t59_l288 (is ((fn [n] (= 2 n)) v58_l286)))


(def v60_l290 (mapv :mark multi-views))
