...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89426#] (Math/sin (* p1__89426# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__89427#] (Math/sin (* p1__89427# 0.3))) (range 30))
    (map (fn* [p1__89428#] (Math/cos (* p1__89428# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__89429#] (Math/sin (* p1__89429# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
