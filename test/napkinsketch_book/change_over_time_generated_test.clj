...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__74779#] (Math/sin (* p1__74779# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__74780#] (Math/sin (* p1__74780# 0.3))) (range 30))
    (map (fn* [p1__74781#] (Math/cos (* p1__74781# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__74782#] (Math/sin (* p1__74782# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
