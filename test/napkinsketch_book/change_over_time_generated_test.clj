...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__78729#] (Math/sin (* p1__78729# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__78730#] (Math/sin (* p1__78730# 0.3))) (range 30))
    (map (fn* [p1__78731#] (Math/cos (* p1__78731# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__78732#] (Math/sin (* p1__78732# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
