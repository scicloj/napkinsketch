...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__74450#] (Math/sin (* p1__74450# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__74451#] (Math/sin (* p1__74451# 0.3))) (range 30))
    (map (fn* [p1__74452#] (Math/cos (* p1__74452# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__74453#] (Math/sin (* p1__74453# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
