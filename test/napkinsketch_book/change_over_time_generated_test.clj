...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__79030#] (Math/sin (* p1__79030# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__79031#] (Math/sin (* p1__79031# 0.3))) (range 30))
    (map (fn* [p1__79032#] (Math/cos (* p1__79032# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__79033#] (Math/sin (* p1__79033# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
