...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__83300#] (Math/sin (* p1__83300# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__83301#] (Math/sin (* p1__83301# 0.3))) (range 30))
    (map (fn* [p1__83302#] (Math/cos (* p1__83302# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__83303#] (Math/sin (* p1__83303# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
