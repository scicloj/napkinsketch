...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__74774#] (Math/sin (* p1__74774# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__74775#] (Math/sin (* p1__74775# 0.3))) (range 30))
    (map (fn* [p1__74776#] (Math/cos (* p1__74776# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__74777#] (Math/sin (* p1__74777# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
