...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__75452#] (Math/sin (* p1__75452# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__75453#] (Math/sin (* p1__75453# 0.3))) (range 30))
    (map (fn* [p1__75454#] (Math/cos (* p1__75454# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__75455#] (Math/sin (* p1__75455# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
