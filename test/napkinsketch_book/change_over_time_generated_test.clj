...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__75568#] (Math/sin (* p1__75568# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__75569#] (Math/sin (* p1__75569# 0.3))) (range 30))
    (map (fn* [p1__75570#] (Math/cos (* p1__75570# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__75571#] (Math/sin (* p1__75571# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
