...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__74860#] (Math/sin (* p1__74860# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (vec (concat (range 30) (range 30))),
   ...
   (vec
    (concat
     (mapv (fn* [p1__74861#] (Math/sin (* p1__74861# 0.3))) (range 30))
     (mapv
      (fn* [p1__74862#] (Math/cos (* p1__74862# 0.3)))
      (range 30)))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (mapv (fn* [p1__74863#] (Math/sin (* p1__74863# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
