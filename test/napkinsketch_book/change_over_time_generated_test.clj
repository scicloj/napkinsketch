...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__67848#] (Math/sin (* p1__67848# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__67849#] (Math/sin (* p1__67849# 0.3))) (range 30))
    (map (fn* [p1__67850#] (Math/cos (* p1__67850# 0.3))) (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__67851#] (Math/sin (* p1__67851# 0.3))) (range 30))}
