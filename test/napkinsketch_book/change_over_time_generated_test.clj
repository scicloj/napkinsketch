...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__122951#] (Math/sin (* p1__122951# 0.3)))
    (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   :y
   (concat
    (map (fn* [p1__122952#] (Math/sin (* p1__122952# 0.3))) (range 30))
    (map
     (fn* [p1__122953#] (Math/cos (* p1__122953# 0.3)))
     (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__122954#] (Math/sin (* p1__122954# 0.3))) (range 30))}
  (sk/lay-area :x :y)))
