...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__1961583#] (Math/sin (* p1__1961583# 0.3)))
    (range 30))}))
...
(def
 ...
 (def
  ...
  {:x (concat (range 30) (range 30)),
   ...
   (concat
    (map
     (fn* [p1__1961584#] (Math/sin (* p1__1961584# 0.3)))
     (range 30))
    (map
     (fn* [p1__1961585#] (Math/cos (* p1__1961585# 0.3)))
     (range 30))),
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map
    (fn* [p1__1961586#] (Math/sin (* p1__1961586# 0.3)))
    (range 30))}
  (sk/lay-area :x :y)))
