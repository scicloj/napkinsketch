 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__75839#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__75839#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__75840#] (= "virginica" p1__75840#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__75841#] (Math/sin (/ p1__75841# 3.0))) (range 20)),
   :change (map (fn* [p1__75842#] (- p1__75842# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__75843#]
     (+ (* 3 p1__75843#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
