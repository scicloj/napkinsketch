 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__99353#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__99353#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__99354#] (= "virginica" p1__99354#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__99355#] (Math/sin (/ p1__99355# 3.0))) (range 20)),
   :change (map (fn* [p1__99356#] (- p1__99356# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__99357#]
     (+ (* 3 p1__99357#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
