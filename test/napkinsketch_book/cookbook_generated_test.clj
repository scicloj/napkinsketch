 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__79546#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__79546#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__79547#] (= "virginica" p1__79547#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__79548#] (Math/sin (/ p1__79548# 3.0))) (range 20)),
   :change (map (fn* [p1__79549#] (- p1__79549# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__79550#]
     (+ (* 3 p1__79550#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
