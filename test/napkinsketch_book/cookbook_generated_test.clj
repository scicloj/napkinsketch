 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__80009#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__80009#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__80010#] (= "virginica" p1__80010#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__80011#] (Math/sin (/ p1__80011# 3.0))) (range 20)),
   :change (map (fn* [p1__80012#] (- p1__80012# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__80013#]
     (+ (* 3 p1__80013#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
