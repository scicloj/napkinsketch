 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__68118#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__68118#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__68119#] (= "virginica" p1__68119#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__68120#] (Math/sin (/ p1__68120# 3.0))) (range 20)),
   :change (map (fn* [p1__68121#] (- p1__68121# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__68122#]
     (+ (* 3 p1__68122#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
