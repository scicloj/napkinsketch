 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__78901#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__78901#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__78902#] (= "virginica" p1__78902#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__78903#] (Math/sin (/ p1__78903# 3.0))) (range 20)),
   :change (map (fn* [p1__78904#] (- p1__78904# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__78905#]
     (+ (* 3 p1__78905#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
