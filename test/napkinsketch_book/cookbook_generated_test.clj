 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__76962#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__76962#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__76963#] (= "virginica" p1__76963#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__76964#] (Math/sin (/ p1__76964# 3.0))) (range 20)),
   :change (map (fn* [p1__76965#] (- p1__76965# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__76966#]
     (+ (* 3 p1__76966#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
