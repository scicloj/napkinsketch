 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__83272#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__83272#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__83273#] (= "virginica" p1__83273#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__83274#] (Math/sin (/ p1__83274# 3.0))) (range 20)),
   :change (map (fn* [p1__83275#] (- p1__83275# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__83276#]
     (+ (* 3 p1__83276#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
