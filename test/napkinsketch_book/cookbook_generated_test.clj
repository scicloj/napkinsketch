 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__79000#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__79000#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__79001#] (= "virginica" p1__79001#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__79002#] (Math/sin (/ p1__79002# 3.0))) (range 20)),
   :change (map (fn* [p1__79003#] (- p1__79003# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__79004#]
     (+ (* 3 p1__79004#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
