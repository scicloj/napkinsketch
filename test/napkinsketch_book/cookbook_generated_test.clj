  ...
  (tc/dataset
   {:date ts-dates,
    ...
    (mapv
     (fn*
      [p1__101802#]
      (+ 100.0 (* 30.0 (Math/sin (* (double p1__101802#) 0.12)))))
     (range 52))}
   {:key-fn keyword})))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__101803#] (= "virginica" p1__101803#))
       (:texts s)))))
   v70_l336)))
 ...
 (->
  (tc/dataset
   {:x (range 20),
    :y
    (map
     (fn* [p1__101804#] (Math/sin (/ p1__101804# 3.0)))
     (range 20)),
    :change (map (fn* [p1__101805#] (- p1__101805# 10)) (range 20))})
  (sk/view :x :y)
