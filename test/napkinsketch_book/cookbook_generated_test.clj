 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__75060#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__75060#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__75061#] (= "virginica" p1__75061#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__75062#] (Math/sin (/ p1__75062# 3.0))) (range 20)),
   :change (map (fn* [p1__75063#] (- p1__75063# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__75064#]
     (+ (* 3 p1__75064#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
