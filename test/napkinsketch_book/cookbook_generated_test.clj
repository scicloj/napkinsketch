 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__71069#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__71069#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__71070#] (= "virginica" p1__71070#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__71071#] (Math/sin (/ p1__71071# 3.0))) (range 20)),
   :change (map (fn* [p1__71072#] (- p1__71072# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__71073#]
     (+ (* 3 p1__71073#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
