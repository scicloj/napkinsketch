 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__68129#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__68129#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__68130#] (= "virginica" p1__68130#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__68131#] (Math/sin (/ p1__68131# 3.0))) (range 20)),
   :change (map (fn* [p1__68132#] (- p1__68132# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__68133#]
     (+ (* 3 p1__68133#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
