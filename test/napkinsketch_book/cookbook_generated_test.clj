  ...
  (tc/dataset
   {:date ts-dates,
    ...
    (mapv
     (fn*
      [p1__117280#]
      (+ 100.0 (* 30.0 (Math/sin (* (double p1__117280#) 0.12)))))
     (range 52))}
   {:key-fn keyword})))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__117281#] (= "virginica" p1__117281#))
       (:texts s)))))
   v70_l336)))
 ...
 (->
  (tc/dataset
   {:x (range 20),
    :y
    (map
     (fn* [p1__117282#] (Math/sin (/ p1__117282# 3.0)))
     (range 20)),
    :change (map (fn* [p1__117283#] (- p1__117283# 10)) (range 20))})
  (sk/view :x :y)
