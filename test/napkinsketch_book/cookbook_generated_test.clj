 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__98949#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__98949#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__98950#] (= "virginica" p1__98950#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__98951#] (Math/sin (/ p1__98951# 3.0))) (range 20)),
   :change (map (fn* [p1__98952#] (- p1__98952# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__98953#]
     (+ (* 3 p1__98953#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
