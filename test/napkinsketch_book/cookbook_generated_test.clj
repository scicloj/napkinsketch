 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__82780#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__82780#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__82781#] (= "virginica" p1__82781#))
       (:texts s)))))
   v64_l288)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__82782#] (Math/sin (/ p1__82782# 3.0))) (range 20)),
   :change (map (fn* [p1__82783#] (- p1__82783# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__82784#]
     (+ (* 3 p1__82784#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
