 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__89703#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__89703#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__89704#] (= "virginica" p1__89704#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__89705#] (Math/sin (/ p1__89705# 3.0))) (range 20)),
   :change (map (fn* [p1__89706#] (- p1__89706# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__89707#]
     (+ (* 3 p1__89707#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
