 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__79197#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__79197#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__79198#] (= "virginica" p1__79198#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__79199#] (Math/sin (/ p1__79199# 3.0))) (range 20)),
   :change (map (fn* [p1__79200#] (- p1__79200# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__79201#]
     (+ (* 3 p1__79201#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
