 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__87771#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__87771#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__87772#] (= "virginica" p1__87772#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__87773#] (Math/sin (/ p1__87773# 3.0))) (range 20)),
   :change (map (fn* [p1__87774#] (- p1__87774# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__87775#]
     (+ (* 3 p1__87775#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
