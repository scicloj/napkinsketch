 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__87868#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__87868#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__87869#] (= "virginica" p1__87869#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__87870#] (Math/sin (/ p1__87870# 3.0))) (range 20)),
   :change (map (fn* [p1__87871#] (- p1__87871# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__87872#]
     (+ (* 3 p1__87872#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
