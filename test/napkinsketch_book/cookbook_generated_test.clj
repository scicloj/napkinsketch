 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__82206#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__82206#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__82207#] (= "virginica" p1__82207#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__82208#] (Math/sin (/ p1__82208# 3.0))) (range 20)),
   :change (map (fn* [p1__82209#] (- p1__82209# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__82210#]
     (+ (* 3 p1__82210#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
