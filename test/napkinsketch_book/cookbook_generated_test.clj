 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__74895#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__74895#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__74896#] (= "virginica" p1__74896#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__74897#] (Math/sin (/ p1__74897# 3.0))) (range 20)),
   :change (map (fn* [p1__74898#] (- p1__74898# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__74899#]
     (+ (* 3 p1__74899#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
