 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__75849#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__75849#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__75850#] (= "virginica" p1__75850#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__75851#] (Math/sin (/ p1__75851# 3.0))) (range 20)),
   :change (map (fn* [p1__75852#] (- p1__75852# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__75853#]
     (+ (* 3 p1__75853#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
