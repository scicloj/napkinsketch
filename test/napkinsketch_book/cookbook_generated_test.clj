 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__82320#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__82320#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__82321#] (= "virginica" p1__82321#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__82322#] (Math/sin (/ p1__82322# 3.0))) (range 20)),
   :change (map (fn* [p1__82323#] (- p1__82323# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__82324#]
     (+ (* 3 p1__82324#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
