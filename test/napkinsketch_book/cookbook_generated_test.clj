 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__85932#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__85932#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__85933#] (= "virginica" p1__85933#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__85934#] (Math/sin (/ p1__85934# 3.0))) (range 20)),
   :change (map (fn* [p1__85935#] (- p1__85935# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__85936#]
     (+ (* 3 p1__85936#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
