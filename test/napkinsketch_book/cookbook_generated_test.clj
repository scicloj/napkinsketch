 ...
 (def
  ...
  {:date ts-dates,
   ...
   (mapv
    (fn*
     [p1__147726#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__147726#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__147727#] (= "virginica" p1__147727#))
       (:texts s)))))
   v70_l335)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__147728#] (Math/sin (/ p1__147728# 3.0))) (range 20)),
   :change (map (fn* [p1__147729#] (- p1__147729# 10)) (range 20))}
  (sk/view :x :y)
