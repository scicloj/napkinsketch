 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__89721#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__89721#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__89722#] (= "virginica" p1__89722#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__89723#] (Math/sin (/ p1__89723# 3.0))) (range 20)),
   :change (map (fn* [p1__89724#] (- p1__89724# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__89725#]
     (+ (* 3 p1__89725#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
