 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__95332#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__95332#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__95333#] (= "virginica" p1__95333#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__95334#] (Math/sin (/ p1__95334# 3.0))) (range 20)),
   :change (map (fn* [p1__95335#] (- p1__95335# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__95336#]
     (+ (* 3 p1__95336#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
