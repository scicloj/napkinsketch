 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__90246#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__90246#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__90247#] (= "virginica" p1__90247#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__90248#] (Math/sin (/ p1__90248# 3.0))) (range 20)),
   :change (map (fn* [p1__90249#] (- p1__90249# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__90250#]
     (+ (* 3 p1__90250#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
