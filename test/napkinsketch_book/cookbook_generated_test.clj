 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__82812#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__82812#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__82813#] (= "virginica" p1__82813#))
       (:texts s)))))
   v67_l303)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__82814#] (Math/sin (/ p1__82814# 3.0))) (range 20)),
   :change (map (fn* [p1__82815#] (- p1__82815# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__82816#]
     (+ (* 3 p1__82816#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
