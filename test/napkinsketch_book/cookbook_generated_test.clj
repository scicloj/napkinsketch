 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__74745#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__74745#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__74746#] (= "virginica" p1__74746#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__74747#] (Math/sin (/ p1__74747# 3.0))) (range 20)),
   :change (map (fn* [p1__74748#] (- p1__74748# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__74749#]
     (+ (* 3 p1__74749#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
