 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__94301#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__94301#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__94302#] (= "virginica" p1__94302#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__94303#] (Math/sin (/ p1__94303# 3.0))) (range 20)),
   :change (map (fn* [p1__94304#] (- p1__94304# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__94305#]
     (+ (* 3 p1__94305#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
