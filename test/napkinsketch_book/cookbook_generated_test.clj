 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__97830#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__97830#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__97831#] (= "virginica" p1__97831#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__97832#] (Math/sin (/ p1__97832# 3.0))) (range 20)),
   :change (map (fn* [p1__97833#] (- p1__97833# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__97834#]
     (+ (* 3 p1__97834#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
