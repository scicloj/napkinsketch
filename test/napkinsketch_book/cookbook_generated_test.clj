 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__84707#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__84707#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__84708#] (= "virginica" p1__84708#))
       (:texts s)))))
   v64_l287)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__84709#] (Math/sin (/ p1__84709# 3.0))) (range 20)),
   :change (map (fn* [p1__84710#] (- p1__84710# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__84711#]
     (+ (* 3 p1__84711#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (sk/lay-point :x :y)
