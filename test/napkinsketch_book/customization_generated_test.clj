 ...
 (def
  ...
  (tc/dataset
   {:x (range 1 50),
    :y
    (mapv
     (fn* [p1__102368#] (* 2 (Math/pow 1.1 p1__102368#)))
     (range 1 50))})))
...
(deftest
 t70_l300
 (is
  ((fn [v] (let [s (sk/svg-summary v)] (= 150 (:points s)))) v69_l294)))
...
(deftest t76_l326 (is ((fn [v] (= :div (first v))) v75_l321)))
...
(deftest t79_l337 (is ((fn [v] (= :div (first v))) v78_l332)))
