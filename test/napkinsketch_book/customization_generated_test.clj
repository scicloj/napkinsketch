 ...
 (def
  ...
  (tc/dataset
   {:x (range 1 50),
    :y
    (mapv
     (fn* [p1__78952#] (* 2 (Math/pow 1.1 p1__78952#)))
     (range 1 50))})))
...
(deftest
 t58_l265
 (is
  ((fn [v] (let [s (sk/svg-summary v)] (= 150 (:points s)))) v57_l259)))
...
(deftest t64_l291 (is ((fn [v] (= :div (first v))) v63_l286)))
...
(deftest t67_l302 (is ((fn [v] (= :div (first v))) v66_l297)))
