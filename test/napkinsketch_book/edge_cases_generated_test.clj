...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__77129#] (keyword (str "cat-" p1__77129#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__77130#] (= "setosa" (p1__77130# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__77131#] (- p1__77131# 10)) (range 20)),
   :val (map (fn* [p1__77132#] (- p1__77132# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__77133#] (* (long p1__77133#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__77134#] (+ 18.0 (* 4.0 (Math/sin (* p1__77134# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__77135#] (+ 20.0 (* 5.0 (Math/sin (* p1__77135# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__77136#] (re-find #":\d\d" p1__77136#))
       (:texts s)))))
   v80_l329)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__77137#] (* (long p1__77137#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__77138#] (+ 100 (* 50 (Math/sin (* p1__77138# 0.4)))))
    (range 20))}
...
(def
 v86_l360
 (->
  {:cat (map (fn* [p1__77139#] (str "cat-" p1__77139#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__77140#] (re-find #"sepal|petal" p1__77140#))
       texts)]
