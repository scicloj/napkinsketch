...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__79060#] (keyword (str "cat-" p1__79060#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__79061#] (= "setosa" (p1__79061# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__79062#] (- p1__79062# 10)) (range 20)),
   :val (map (fn* [p1__79063#] (- p1__79063# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__79064#] (* (long p1__79064#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__79065#] (+ 18.0 (* 4.0 (Math/sin (* p1__79065# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__79066#] (+ 20.0 (* 5.0 (Math/sin (* p1__79066# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__79067#] (re-find #":\d\d" p1__79067#))
       (:texts s)))))
   v80_l329)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__79068#] (* (long p1__79068#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__79069#] (+ 100 (* 50 (Math/sin (* p1__79069# 0.4)))))
    (range 20))}
...
(def
 v86_l360
 (->
  {:cat (map (fn* [p1__79070#] (str "cat-" p1__79070#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__79071#] (re-find #"sepal|petal" p1__79071#))
       texts)]
