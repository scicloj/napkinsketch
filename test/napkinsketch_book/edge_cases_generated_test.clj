...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86318#] (keyword (str "cat-" p1__86318#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86319#] (= "setosa" (p1__86319# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86320#] (- p1__86320# 10)) (range 20)),
   :val (map (fn* [p1__86321#] (- p1__86321# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86322#] (* (long p1__86322#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86323#] (+ 18.0 (* 4.0 (Math/sin (* p1__86323# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86324#] (+ 20.0 (* 5.0 (Math/sin (* p1__86324# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86325#] (re-find #":\d\d" p1__86325#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86326#] (* (long p1__86326#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86327#] (+ 100 (* 50 (Math/sin (* p1__86327# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86328#] (str "cat-" p1__86328#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86329#] (re-find #"sepal|petal" p1__86329#))
       texts)]
