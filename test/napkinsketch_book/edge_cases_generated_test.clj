...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86254#] (keyword (str "cat-" p1__86254#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86255#] (= "setosa" (p1__86255# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86256#] (- p1__86256# 10)) (range 20)),
   :val (map (fn* [p1__86257#] (- p1__86257# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86258#] (* (long p1__86258#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86259#] (+ 18.0 (* 4.0 (Math/sin (* p1__86259# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86260#] (+ 20.0 (* 5.0 (Math/sin (* p1__86260# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86261#] (re-find #":\d\d" p1__86261#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86262#] (* (long p1__86262#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86263#] (+ 100 (* 50 (Math/sin (* p1__86263# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86264#] (str "cat-" p1__86264#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86265#] (re-find #"sepal|petal" p1__86265#))
       texts)]
