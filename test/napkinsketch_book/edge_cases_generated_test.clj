...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__98602#] (keyword (str "cat-" p1__98602#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__98603#] (= "setosa" (p1__98603# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__98604#] (- p1__98604# 10)) (range 20)),
   :val (map (fn* [p1__98605#] (- p1__98605# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__98606#] (* (long p1__98606#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__98607#] (+ 18.0 (* 4.0 (Math/sin (* p1__98607# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__98608#] (+ 20.0 (* 5.0 (Math/sin (* p1__98608# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__98609#] (re-find #":\d\d" p1__98609#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__98610#] (* (long p1__98610#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__98611#] (+ 100 (* 50 (Math/sin (* p1__98611# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__98612#] (str "cat-" p1__98612#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__98613#] (re-find #"sepal|petal" p1__98613#))
       texts)]
