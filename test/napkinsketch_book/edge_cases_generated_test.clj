...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__224097#] (keyword (str "cat-" p1__224097#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__224098#] (= "setosa" (p1__224098# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__224099#] (- p1__224099# 10)) (range 20)),
   :val (map (fn* [p1__224100#] (- p1__224100# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__224101#] (* (long p1__224101#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__224102#] (+ 18.0 (* 4.0 (Math/sin (* p1__224102# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__224103#] (+ 20.0 (* 5.0 (Math/sin (* p1__224103# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__224104#] (re-find #":\d\d" p1__224104#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__224105#] (* (long p1__224105#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__224106#] (+ 100 (* 50 (Math/sin (* p1__224106# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__224107#] (str "cat-" p1__224107#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__224108#] (re-find #"sepal|petal" p1__224108#))
       texts)]
