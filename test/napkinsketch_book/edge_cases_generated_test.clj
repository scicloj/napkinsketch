...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86145#] (keyword (str "cat-" p1__86145#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86146#] (= "setosa" (p1__86146# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86147#] (- p1__86147# 10)) (range 20)),
   :val (map (fn* [p1__86148#] (- p1__86148# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86149#] (* (long p1__86149#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86150#] (+ 18.0 (* 4.0 (Math/sin (* p1__86150# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86151#] (+ 20.0 (* 5.0 (Math/sin (* p1__86151# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86152#] (re-find #":\d\d" p1__86152#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86153#] (* (long p1__86153#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86154#] (+ 100 (* 50 (Math/sin (* p1__86154# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86155#] (str "cat-" p1__86155#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86156#] (re-find #"sepal|petal" p1__86156#))
       texts)]
