...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__120364#] (keyword (str "cat-" p1__120364#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__120365#] (= "setosa" (p1__120365# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__120366#] (- p1__120366# 10)) (range 20)),
   :val (map (fn* [p1__120367#] (- p1__120367# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__120368#] (* (long p1__120368#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__120369#] (+ 18.0 (* 4.0 (Math/sin (* p1__120369# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__120370#] (+ 20.0 (* 5.0 (Math/sin (* p1__120370# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__120371#] (re-find #":\d\d" p1__120371#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__120372#] (* (long p1__120372#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__120373#] (+ 100 (* 50 (Math/sin (* p1__120373# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__120374#] (str "cat-" p1__120374#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__120375#] (re-find #"sepal|petal" p1__120375#))
       texts)]
