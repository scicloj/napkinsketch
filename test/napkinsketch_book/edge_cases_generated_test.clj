...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__78753#] (keyword (str "cat-" p1__78753#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__78754#] (= "setosa" (p1__78754# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__78755#] (- p1__78755# 10)) (range 20)),
   :val (map (fn* [p1__78756#] (- p1__78756# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78757#] (* (long p1__78757#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__78758#] (+ 18.0 (* 4.0 (Math/sin (* p1__78758# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__78759#] (+ 20.0 (* 5.0 (Math/sin (* p1__78759# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__78760#] (re-find #":\d\d" p1__78760#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78761#] (* (long p1__78761#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__78762#] (+ 100 (* 50 (Math/sin (* p1__78762# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__78763#] (str "cat-" p1__78763#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__78764#] (re-find #"sepal|petal" p1__78764#))
       texts)]
