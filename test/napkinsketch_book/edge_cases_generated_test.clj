...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__82038#] (keyword (str "cat-" p1__82038#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__82039#] (= "setosa" (p1__82039# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__82040#] (- p1__82040# 10)) (range 20)),
   :val (map (fn* [p1__82041#] (- p1__82041# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__82042#] (* (long p1__82042#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__82043#] (+ 18.0 (* 4.0 (Math/sin (* p1__82043# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__82044#] (+ 20.0 (* 5.0 (Math/sin (* p1__82044# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__82045#] (re-find #":\d\d" p1__82045#))
       (:texts s)))))
   v80_l329)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__82046#] (* (long p1__82046#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__82047#] (+ 100 (* 50 (Math/sin (* p1__82047# 0.4)))))
    (range 20))}
...
(def
 v86_l360
 (->
  {:cat (map (fn* [p1__82048#] (str "cat-" p1__82048#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__82049#] (re-find #"sepal|petal" p1__82049#))
       texts)]
