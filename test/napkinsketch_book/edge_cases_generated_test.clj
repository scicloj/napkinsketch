...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86848#] (keyword (str "cat-" p1__86848#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86849#] (= "setosa" (p1__86849# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86850#] (- p1__86850# 10)) (range 20)),
   :val (map (fn* [p1__86851#] (- p1__86851# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86852#] (* (long p1__86852#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86853#] (+ 18.0 (* 4.0 (Math/sin (* p1__86853# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86854#] (+ 20.0 (* 5.0 (Math/sin (* p1__86854# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86855#] (re-find #":\d\d" p1__86855#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86856#] (* (long p1__86856#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86857#] (+ 100 (* 50 (Math/sin (* p1__86857# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86858#] (str "cat-" p1__86858#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86859#] (re-find #"sepal|petal" p1__86859#))
       texts)]
