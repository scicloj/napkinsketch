...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86412#] (keyword (str "cat-" p1__86412#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86413#] (= "setosa" (p1__86413# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86414#] (- p1__86414# 10)) (range 20)),
   :val (map (fn* [p1__86415#] (- p1__86415# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86416#] (* (long p1__86416#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86417#] (+ 18.0 (* 4.0 (Math/sin (* p1__86417# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86418#] (+ 20.0 (* 5.0 (Math/sin (* p1__86418# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86419#] (re-find #":\d\d" p1__86419#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86420#] (* (long p1__86420#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86421#] (+ 100 (* 50 (Math/sin (* p1__86421# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86422#] (str "cat-" p1__86422#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86423#] (re-find #"sepal|petal" p1__86423#))
       texts)]
