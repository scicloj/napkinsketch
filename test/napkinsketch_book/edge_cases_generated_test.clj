...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__96565#] (keyword (str "cat-" p1__96565#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__96566#] (= "setosa" (p1__96566# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__96567#] (- p1__96567# 10)) (range 20)),
   :val (map (fn* [p1__96568#] (- p1__96568# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96569#] (* (long p1__96569#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__96570#] (+ 18.0 (* 4.0 (Math/sin (* p1__96570# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__96571#] (+ 20.0 (* 5.0 (Math/sin (* p1__96571# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__96572#] (re-find #":\d\d" p1__96572#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96573#] (* (long p1__96573#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__96574#] (+ 100 (* 50 (Math/sin (* p1__96574# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__96575#] (str "cat-" p1__96575#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__96576#] (re-find #"sepal|petal" p1__96576#))
       texts)]
