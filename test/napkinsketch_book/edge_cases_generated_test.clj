...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__179887#] (keyword (str "cat-" p1__179887#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__179888#] (= "setosa" (p1__179888# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__179889#] (- p1__179889# 10)) (range 20)),
   :val (map (fn* [p1__179890#] (- p1__179890# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__179891#] (* (long p1__179891#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__179892#] (+ 18.0 (* 4.0 (Math/sin (* p1__179892# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__179893#] (+ 20.0 (* 5.0 (Math/sin (* p1__179893# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__179894#] (re-find #":\d\d" p1__179894#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__179895#] (* (long p1__179895#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__179896#] (+ 100 (* 50 (Math/sin (* p1__179896# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__179897#] (str "cat-" p1__179897#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__179898#] (re-find #"sepal|petal" p1__179898#))
       texts)]
