...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__187921#] (keyword (str "cat-" p1__187921#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__187922#] (= "setosa" (p1__187922# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__187923#] (- p1__187923# 10)) (range 20)),
   :val (map (fn* [p1__187924#] (- p1__187924# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__187925#] (* (long p1__187925#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__187926#] (+ 18.0 (* 4.0 (Math/sin (* p1__187926# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__187927#] (+ 20.0 (* 5.0 (Math/sin (* p1__187927# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__187928#] (re-find #":\d\d" p1__187928#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__187929#] (* (long p1__187929#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__187930#] (+ 100 (* 50 (Math/sin (* p1__187930# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__187931#] (str "cat-" p1__187931#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__187932#] (re-find #"sepal|petal" p1__187932#))
       texts)]
