...
(def
 ...
 (->
  (let
   ...
   {:category
    (mapv
     (fn* [p1__114650#] (keyword (str "cat-" p1__114650#)))
     (range 12)),
...
(def
 ...
 (->
  iris
  (tc/select-rows
   (fn* [p1__114651#] (= "setosa" (p1__114651# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__114652#] (- p1__114652# 10)) (range 20)),
   :val (map (fn* [p1__114653#] (- p1__114653# 10.0)) (range 20))}
   ...
   (mapv
    (fn*
     ...
     (java.time.LocalDateTime/of
      ...
      15
      (+ 8 (int (/ p1__114654# 4)))
      (* 15 (mod (int p1__114654#) 4))
      0))
    (range 24)),
   :value
   (mapv
    (fn* [p1__114655#] (+ 18.0 (* 4.0 (Math/sin (* p1__114655# 0.3)))))
    (range 24))}
   ...
   (mapv
    (fn*
     ...
     (java.time.Instant/ofEpochSecond
      (+ 1750003200 (* p1__114656# 3600))))
    (range 12)),
   :temp
   (mapv
    (fn* [p1__114657#] (+ 20.0 (* 5.0 (Math/sin (* p1__114657# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__114658#] (re-find #":\d\d" p1__114658#))
       (:texts s)))))
   v81_l326)))
   ...
   (mapv
    (fn*
     ...
     (java.time.LocalDate/ofEpochDay
      (+ 18262 (* (long p1__114659#) 120))))
    (range 20)),
   :value
   (mapv
    (fn* [p1__114660#] (+ 100 (* 50 (Math/sin (* p1__114660# 0.4)))))
    (range 20))}
...
(def
 v87_l356
 (->
  {:cat (map (fn* [p1__114661#] (str "cat-" p1__114661#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__114662#] (re-find #"sepal|petal" p1__114662#))
       texts)]
