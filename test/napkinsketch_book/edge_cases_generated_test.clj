...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__139222#] (keyword (str "cat-" p1__139222#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__139223#] (= "setosa" (p1__139223# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__139224#] (- p1__139224# 10)) (range 20)),
   :val (map (fn* [p1__139225#] (- p1__139225# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__139226#] (* (long p1__139226#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__139227#] (+ 18.0 (* 4.0 (Math/sin (* p1__139227# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__139228#] (+ 20.0 (* 5.0 (Math/sin (* p1__139228# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__139229#] (re-find #":\d\d" p1__139229#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__139230#] (* (long p1__139230#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__139231#] (+ 100 (* 50 (Math/sin (* p1__139231# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__139232#] (str "cat-" p1__139232#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__139233#] (re-find #"sepal|petal" p1__139233#))
       texts)]
