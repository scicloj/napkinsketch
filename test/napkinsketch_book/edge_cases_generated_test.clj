...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__78107#] (keyword (str "cat-" p1__78107#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__78108#] (= "setosa" (p1__78108# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__78109#] (- p1__78109# 10)) (range 20)),
   :val (map (fn* [p1__78110#] (- p1__78110# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78111#] (* (long p1__78111#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__78112#] (+ 18.0 (* 4.0 (Math/sin (* p1__78112# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__78113#] (+ 20.0 (* 5.0 (Math/sin (* p1__78113# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__78114#] (re-find #":\d\d" p1__78114#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78115#] (* (long p1__78115#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__78116#] (+ 100 (* 50 (Math/sin (* p1__78116# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__78117#] (str "cat-" p1__78117#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__78118#] (re-find #"sepal|petal" p1__78118#))
       texts)]
