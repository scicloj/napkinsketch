...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__76806#] (keyword (str "cat-" p1__76806#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__76807#] (= "setosa" (p1__76807# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__76808#] (- p1__76808# 10)) (range 20)),
   :val (map (fn* [p1__76809#] (- p1__76809# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__76810#] (* (long p1__76810#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__76811#] (+ 18.0 (* 4.0 (Math/sin (* p1__76811# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__76812#] (+ 20.0 (* 5.0 (Math/sin (* p1__76812# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__76813#] (re-find #":\d\d" p1__76813#))
       (:texts s)))))
   v80_l329)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__76814#] (* (long p1__76814#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__76815#] (+ 100 (* 50 (Math/sin (* p1__76815# 0.4)))))
    (range 20))}
...
(def
 v86_l360
 (->
  {:cat (map (fn* [p1__76816#] (str "cat-" p1__76816#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__76817#] (re-find #"sepal|petal" p1__76817#))
       texts)]
