...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__85119#] (keyword (str "cat-" p1__85119#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__85120#] (= "setosa" (p1__85120# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__85121#] (- p1__85121# 10)) (range 20)),
   :val (map (fn* [p1__85122#] (- p1__85122# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__85123#] (* (long p1__85123#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__85124#] (+ 18.0 (* 4.0 (Math/sin (* p1__85124# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__85125#] (+ 20.0 (* 5.0 (Math/sin (* p1__85125# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__85126#] (re-find #":\d\d" p1__85126#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__85127#] (* (long p1__85127#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__85128#] (+ 100 (* 50 (Math/sin (* p1__85128# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__85129#] (str "cat-" p1__85129#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__85130#] (re-find #"sepal|petal" p1__85130#))
       texts)]
