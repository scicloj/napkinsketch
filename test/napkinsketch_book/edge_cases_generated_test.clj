...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__90843#] (keyword (str "cat-" p1__90843#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__90844#] (= "setosa" (p1__90844# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__90845#] (- p1__90845# 10)) (range 20)),
   :val (map (fn* [p1__90846#] (- p1__90846# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90847#] (* (long p1__90847#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__90848#] (+ 18.0 (* 4.0 (Math/sin (* p1__90848# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__90849#] (+ 20.0 (* 5.0 (Math/sin (* p1__90849# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__90850#] (re-find #":\d\d" p1__90850#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90851#] (* (long p1__90851#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__90852#] (+ 100 (* 50 (Math/sin (* p1__90852# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__90853#] (str "cat-" p1__90853#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__90854#] (re-find #"sepal|petal" p1__90854#))
       texts)]
