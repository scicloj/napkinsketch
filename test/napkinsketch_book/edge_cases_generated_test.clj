...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__100094#] (keyword (str "cat-" p1__100094#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__100095#] (= "setosa" (p1__100095# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__100096#] (- p1__100096# 10)) (range 20)),
   :val (map (fn* [p1__100097#] (- p1__100097# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__100098#] (* (long p1__100098#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__100099#] (+ 18.0 (* 4.0 (Math/sin (* p1__100099# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__100100#] (+ 20.0 (* 5.0 (Math/sin (* p1__100100# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__100101#] (re-find #":\d\d" p1__100101#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__100102#] (* (long p1__100102#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__100103#] (+ 100 (* 50 (Math/sin (* p1__100103# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__100104#] (str "cat-" p1__100104#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__100105#] (re-find #"sepal|petal" p1__100105#))
       texts)]
