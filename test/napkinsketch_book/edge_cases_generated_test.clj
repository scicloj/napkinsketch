...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__91967#] (keyword (str "cat-" p1__91967#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__91968#] (= "setosa" (p1__91968# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__91969#] (- p1__91969# 10)) (range 20)),
   :val (map (fn* [p1__91970#] (- p1__91970# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__91971#] (* (long p1__91971#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__91972#] (+ 18.0 (* 4.0 (Math/sin (* p1__91972# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__91973#] (+ 20.0 (* 5.0 (Math/sin (* p1__91973# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__91974#] (re-find #":\d\d" p1__91974#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__91975#] (* (long p1__91975#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__91976#] (+ 100 (* 50 (Math/sin (* p1__91976# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__91977#] (str "cat-" p1__91977#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__91978#] (re-find #"sepal|petal" p1__91978#))
       texts)]
