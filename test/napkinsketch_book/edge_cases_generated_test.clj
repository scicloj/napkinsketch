...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__132905#] (keyword (str "cat-" p1__132905#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__132906#] (= "setosa" (p1__132906# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__132907#] (- p1__132907# 10)) (range 20)),
   :val (map (fn* [p1__132908#] (- p1__132908# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__132909#] (* (long p1__132909#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__132910#] (+ 18.0 (* 4.0 (Math/sin (* p1__132910# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__132911#] (+ 20.0 (* 5.0 (Math/sin (* p1__132911# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__132912#] (re-find #":\d\d" p1__132912#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__132913#] (* (long p1__132913#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__132914#] (+ 100 (* 50 (Math/sin (* p1__132914# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__132915#] (str "cat-" p1__132915#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__132916#] (re-find #"sepal|petal" p1__132916#))
       texts)]
