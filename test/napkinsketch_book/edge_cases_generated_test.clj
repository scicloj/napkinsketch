...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__233099#] (keyword (str "cat-" p1__233099#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__233100#] (= "setosa" (p1__233100# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__233101#] (- p1__233101# 10)) (range 20)),
   :val (map (fn* [p1__233102#] (- p1__233102# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__233103#] (* (long p1__233103#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__233104#] (+ 18.0 (* 4.0 (Math/sin (* p1__233104# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__233105#] (+ 20.0 (* 5.0 (Math/sin (* p1__233105# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__233106#] (re-find #":\d\d" p1__233106#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__233107#] (* (long p1__233107#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__233108#] (+ 100 (* 50 (Math/sin (* p1__233108# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__233109#] (str "cat-" p1__233109#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__233110#] (re-find #"sepal|petal" p1__233110#))
       texts)]
