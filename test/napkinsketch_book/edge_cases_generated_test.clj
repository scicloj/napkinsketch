...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__1964204#] (keyword (str "cat-" p1__1964204#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__1964205#] (= "setosa" (p1__1964205# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__1964206#] (- p1__1964206# 10)) (range 20)),
   :val (map (fn* [p1__1964207#] (- p1__1964207# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__1964208#] (* (long p1__1964208#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn*
     [p1__1964209#]
     (+ 18.0 (* 4.0 (Math/sin (* p1__1964209# 0.3)))))
    (range 24))}
 ...
 (->
  {:time
   ...
   (map
    (fn*
     [p1__1964210#]
     (+ 20.0 (* 5.0 (Math/sin (* p1__1964210# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__1964211#] (re-find #":\d\d" p1__1964211#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__1964212#] (* (long p1__1964212#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__1964213#] (+ 100 (* 50 (Math/sin (* p1__1964213# 0.4)))))
    (range 20))}
...
(def
 ...
 (->
  {:cat
   (map (fn* [p1__1964214#] (str "cat-" p1__1964214#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__1964215#] (re-find #"sepal|petal" p1__1964215#))
       texts)]
