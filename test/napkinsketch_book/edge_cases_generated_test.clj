...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__86737#] (keyword (str "cat-" p1__86737#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__86738#] (= "setosa" (p1__86738# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__86739#] (- p1__86739# 10)) (range 20)),
   :val (map (fn* [p1__86740#] (- p1__86740# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86741#] (* (long p1__86741#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__86742#] (+ 18.0 (* 4.0 (Math/sin (* p1__86742# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__86743#] (+ 20.0 (* 5.0 (Math/sin (* p1__86743# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__86744#] (re-find #":\d\d" p1__86744#))
       (:texts s)))))
   v87_l360)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__86745#] (* (long p1__86745#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__86746#] (+ 100 (* 50 (Math/sin (* p1__86746# 0.4)))))
    (range 20))}
...
(def
 v93_l391
 (->
  {:cat (map (fn* [p1__86747#] (str "cat-" p1__86747#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__86748#] (re-find #"sepal|petal" p1__86748#))
       texts)]
