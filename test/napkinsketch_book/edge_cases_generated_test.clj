...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__170121#] (keyword (str "cat-" p1__170121#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__170122#] (= "setosa" (p1__170122# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__170123#] (- p1__170123# 10)) (range 20)),
   :val (map (fn* [p1__170124#] (- p1__170124# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__170125#] (* (long p1__170125#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__170126#] (+ 18.0 (* 4.0 (Math/sin (* p1__170126# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__170127#] (+ 20.0 (* 5.0 (Math/sin (* p1__170127# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__170128#] (re-find #":\d\d" p1__170128#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__170129#] (* (long p1__170129#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__170130#] (+ 100 (* 50 (Math/sin (* p1__170130# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__170131#] (str "cat-" p1__170131#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__170132#] (re-find #"sepal|petal" p1__170132#))
       texts)]
