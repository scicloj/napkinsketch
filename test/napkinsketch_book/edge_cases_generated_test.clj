...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__165164#] (keyword (str "cat-" p1__165164#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__165165#] (= "setosa" (p1__165165# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__165166#] (- p1__165166# 10)) (range 20)),
   :val (map (fn* [p1__165167#] (- p1__165167# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__165168#] (* (long p1__165168#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__165169#] (+ 18.0 (* 4.0 (Math/sin (* p1__165169# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__165170#] (+ 20.0 (* 5.0 (Math/sin (* p1__165170# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__165171#] (re-find #":\d\d" p1__165171#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__165172#] (* (long p1__165172#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__165173#] (+ 100 (* 50 (Math/sin (* p1__165173# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__165174#] (str "cat-" p1__165174#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__165175#] (re-find #"sepal|petal" p1__165175#))
       texts)]
