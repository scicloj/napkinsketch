...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__81839#] (keyword (str "cat-" p1__81839#)))
     (range 12)),
...
(def
 ...
 (->
  data/iris
  (tc/select-rows
   (fn* [p1__81840#] (= "setosa" (p1__81840# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__81841#] (- p1__81841# 10)) (range 20)),
   :val (map (fn* [p1__81842#] (- p1__81842# 10.0)) (range 20))}
   ...
   (map
    (fn*
     ...
     (java.time.LocalDateTime/of
      ...
      15
      (+ 8 (int (/ p1__81843# 4)))
      (* 15 (mod (int p1__81843#) 4))
      0))
    (range 24)),
   :value
   (map
    (fn* [p1__81844#] (+ 18.0 (* 4.0 (Math/sin (* p1__81844# 0.3)))))
    (range 24))}
   ...
   (map
    (fn*
     ...
     (java.time.Instant/ofEpochSecond
      (+ 1750003200 (* p1__81845# 3600))))
    (range 12)),
   :temp
   (map
    (fn* [p1__81846#] (+ 20.0 (* 5.0 (Math/sin (* p1__81846# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__81847#] (re-find #":\d\d" p1__81847#))
       (:texts s)))))
   v80_l325)))
   ...
   (map
    (fn*
     ...
     (java.time.LocalDate/ofEpochDay
      (+ 18262 (* (long p1__81848#) 120))))
    (range 20)),
   :value
   (map
    (fn* [p1__81849#] (+ 100 (* 50 (Math/sin (* p1__81849# 0.4)))))
    (range 20))}
...
(def
 v86_l355
 (->
  {:cat (map (fn* [p1__81850#] (str "cat-" p1__81850#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      strip-labels
      (filter
       (fn* [p1__81851#] (re-find #"sepal|petal" p1__81851#))
       texts)]
