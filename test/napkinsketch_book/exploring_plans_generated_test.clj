...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__90063#] (= 50 (:n-points p1__90063#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__90064#] (< (:lo p1__90064#) (:hi p1__90064#)))
      bars)
     (every? (fn* [p1__90065#] (pos? (:count p1__90065#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__90066#] (Math/sin (* p1__90066# 0.3))) (range 30))}))
