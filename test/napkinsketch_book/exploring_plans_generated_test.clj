...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__209660#] (= 50 (:n-points p1__209660#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__209661#] (< (:lo p1__209661#) (:hi p1__209661#)))
      bars)
     (every? (fn* [p1__209662#] (pos? (:count p1__209662#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__209663#] (Math/sin (* p1__209663# 0.3)))
    (range 30))}))
