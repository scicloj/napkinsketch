...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85957#] (= 50 (:n-points p1__85957#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85958#] (< (:lo p1__85958#) (:hi p1__85958#)))
      bars)
     (every? (fn* [p1__85959#] (pos? (:count p1__85959#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85960#] (Math/sin (* p1__85960# 0.3))) (range 30))}))
