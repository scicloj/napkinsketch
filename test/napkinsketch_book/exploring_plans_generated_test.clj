...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__84339#] (= 50 (:n-points p1__84339#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__84340#] (< (:lo p1__84340#) (:hi p1__84340#)))
      bars)
     (every? (fn* [p1__84341#] (pos? (:count p1__84341#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__84342#] (Math/sin (* p1__84342# 0.3))) (range 30))}))
