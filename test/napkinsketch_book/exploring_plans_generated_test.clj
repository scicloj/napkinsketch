...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__97822#] (= 50 (:n-points p1__97822#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__97823#] (< (:lo p1__97823#) (:hi p1__97823#)))
      bars)
     (every? (fn* [p1__97824#] (pos? (:count p1__97824#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__97825#] (Math/sin (* p1__97825# 0.3))) (range 30))}))
