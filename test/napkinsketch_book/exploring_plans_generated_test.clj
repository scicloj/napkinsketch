...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__200853#] (= 50 (:n-points p1__200853#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__200854#] (< (:lo p1__200854#) (:hi p1__200854#)))
      bars)
     (every? (fn* [p1__200855#] (pos? (:count p1__200855#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__200856#] (Math/sin (* p1__200856# 0.3)))
    (range 30))}))
