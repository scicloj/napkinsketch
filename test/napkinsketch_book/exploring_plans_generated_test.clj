...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85632#] (= 50 (:n-points p1__85632#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85633#] (< (:lo p1__85633#) (:hi p1__85633#)))
      bars)
     (every? (fn* [p1__85634#] (pos? (:count p1__85634#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85635#] (Math/sin (* p1__85635# 0.3))) (range 30))}))
