...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__90283#] (= 50 (:n-points p1__90283#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__90284#] (< (:lo p1__90284#) (:hi p1__90284#)))
      bars)
     (every? (fn* [p1__90285#] (pos? (:count p1__90285#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__90286#] (Math/sin (* p1__90286# 0.3))) (range 30))}))
