...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86114#] (= 50 (:n-points p1__86114#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86115#] (< (:lo p1__86115#) (:hi p1__86115#)))
      bars)
     (every? (fn* [p1__86116#] (pos? (:count p1__86116#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86117#] (Math/sin (* p1__86117# 0.3))) (range 30))}))
