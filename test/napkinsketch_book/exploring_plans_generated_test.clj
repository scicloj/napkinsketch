...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86494#] (= 50 (:n-points p1__86494#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86495#] (< (:lo p1__86495#) (:hi p1__86495#)))
      bars)
     (every? (fn* [p1__86496#] (pos? (:count p1__86496#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86497#] (Math/sin (* p1__86497# 0.3))) (range 30))}))
