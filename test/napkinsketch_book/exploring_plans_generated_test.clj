...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85365#] (= 50 (:n-points p1__85365#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85366#] (< (:lo p1__85366#) (:hi p1__85366#)))
      bars)
     (every? (fn* [p1__85367#] (pos? (:count p1__85367#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85368#] (Math/sin (* p1__85368# 0.3))) (range 30))}))
