...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__92272#] (= 50 (:n-points p1__92272#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__92273#] (< (:lo p1__92273#) (:hi p1__92273#)))
      bars)
     (every? (fn* [p1__92274#] (pos? (:count p1__92274#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__92275#] (Math/sin (* p1__92275# 0.3))) (range 30))}))
