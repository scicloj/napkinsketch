...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__187141#] (= 50 (:n-points p1__187141#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__187142#] (< (:lo p1__187142#) (:hi p1__187142#)))
      bars)
     (every? (fn* [p1__187143#] (pos? (:count p1__187143#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__187144#] (Math/sin (* p1__187144# 0.3)))
    (range 30))}))
