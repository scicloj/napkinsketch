...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__125812#] (= 50 (:n-points p1__125812#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__125813#] (< (:lo p1__125813#) (:hi p1__125813#)))
      bars)
     (every? (fn* [p1__125814#] (pos? (:count p1__125814#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__125815#] (Math/sin (* p1__125815# 0.3)))
    (range 30))}))
