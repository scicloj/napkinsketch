...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85538#] (= 50 (:n-points p1__85538#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85539#] (< (:lo p1__85539#) (:hi p1__85539#)))
      bars)
     (every? (fn* [p1__85540#] (pos? (:count p1__85540#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85541#] (Math/sin (* p1__85541# 0.3))) (range 30))}))
