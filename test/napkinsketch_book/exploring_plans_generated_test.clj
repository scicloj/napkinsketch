...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86150#] (= 50 (:n-points p1__86150#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86151#] (< (:lo p1__86151#) (:hi p1__86151#)))
      bars)
     (every? (fn* [p1__86152#] (pos? (:count p1__86152#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86153#] (Math/sin (* p1__86153# 0.3))) (range 30))}))
