...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__98891#] (= 50 (:n-points p1__98891#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__98892#] (< (:lo p1__98892#) (:hi p1__98892#)))
      bars)
     (every? (fn* [p1__98893#] (pos? (:count p1__98893#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__98894#] (Math/sin (* p1__98894# 0.3))) (range 30))}))
