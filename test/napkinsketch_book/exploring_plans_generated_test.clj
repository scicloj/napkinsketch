...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__93082#] (= 50 (:n-points p1__93082#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__93083#] (< (:lo p1__93083#) (:hi p1__93083#)))
      bars)
     (every? (fn* [p1__93084#] (pos? (:count p1__93084#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__93085#] (Math/sin (* p1__93085# 0.3))) (range 30))}))
