...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87351#] (= 50 (:n-points p1__87351#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87352#] (< (:lo p1__87352#) (:hi p1__87352#)))
      bars)
     (every? (fn* [p1__87353#] (pos? (:count p1__87353#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87354#] (Math/sin (* p1__87354# 0.3))) (range 30))}))
