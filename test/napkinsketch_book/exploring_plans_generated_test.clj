...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85545#] (= 50 (:n-points p1__85545#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85546#] (< (:lo p1__85546#) (:hi p1__85546#)))
      bars)
     (every? (fn* [p1__85547#] (pos? (:count p1__85547#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85548#] (Math/sin (* p1__85548# 0.3))) (range 30))}))
