...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__179107#] (= 50 (:n-points p1__179107#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__179108#] (< (:lo p1__179108#) (:hi p1__179108#)))
      bars)
     (every? (fn* [p1__179109#] (pos? (:count p1__179109#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__179110#] (Math/sin (* p1__179110# 0.3)))
    (range 30))}))
