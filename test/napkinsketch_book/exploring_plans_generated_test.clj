...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__232319#] (= 50 (:n-points p1__232319#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__232320#] (< (:lo p1__232320#) (:hi p1__232320#)))
      bars)
     (every? (fn* [p1__232321#] (pos? (:count p1__232321#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__232322#] (Math/sin (* p1__232322# 0.3)))
    (range 30))}))
