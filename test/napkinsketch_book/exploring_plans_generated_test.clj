...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__132125#] (= 50 (:n-points p1__132125#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__132126#] (< (:lo p1__132126#) (:hi p1__132126#)))
      bars)
     (every? (fn* [p1__132127#] (pos? (:count p1__132127#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__132128#] (Math/sin (* p1__132128# 0.3)))
    (range 30))}))
