...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__2510392#] (= 50 (:n-points p1__2510392#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__2510393#] (< (:lo p1__2510393#) (:hi p1__2510393#)))
      bars)
     (every? (fn* [p1__2510394#] (pos? (:count p1__2510394#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__2510395#] (Math/sin (* p1__2510395# 0.3)))
    (range 30))}))
