...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__164384#] (= 50 (:n-points p1__164384#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__164385#] (< (:lo p1__164385#) (:hi p1__164385#)))
      bars)
     (every? (fn* [p1__164386#] (pos? (:count p1__164386#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__164387#] (Math/sin (* p1__164387# 0.3)))
    (range 30))}))
