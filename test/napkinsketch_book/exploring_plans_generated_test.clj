...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__1963424#] (= 50 (:n-points p1__1963424#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__1963425#] (< (:lo p1__1963425#) (:hi p1__1963425#)))
      bars)
     (every? (fn* [p1__1963426#] (pos? (:count p1__1963426#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__1963427#] (Math/sin (* p1__1963427# 0.3)))
    (range 30))}))
