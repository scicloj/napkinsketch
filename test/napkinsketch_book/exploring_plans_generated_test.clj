...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__223317#] (= 50 (:n-points p1__223317#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__223318#] (< (:lo p1__223318#) (:hi p1__223318#)))
      bars)
     (every? (fn* [p1__223319#] (pos? (:count p1__223319#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__223320#] (Math/sin (* p1__223320# 0.3)))
    (range 30))}))
