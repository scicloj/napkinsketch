...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__153152#] (= 50 (:n-points p1__153152#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__153153#] (< (:lo p1__153153#) (:hi p1__153153#)))
      bars)
     (every? (fn* [p1__153154#] (pos? (:count p1__153154#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__153155#] (Math/sin (* p1__153155# 0.3)))
    (range 30))}))
