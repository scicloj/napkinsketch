...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__119499#] (= 50 (:n-points p1__119499#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__119500#] (< (:lo p1__119500#) (:hi p1__119500#)))
      bars)
     (every? (fn* [p1__119501#] (pos? (:count p1__119501#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__119502#] (Math/sin (* p1__119502# 0.3)))
    (range 30))}))
