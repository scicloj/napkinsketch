...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86068#] (= 50 (:n-points p1__86068#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86069#] (< (:lo p1__86069#) (:hi p1__86069#)))
      bars)
     (every? (fn* [p1__86070#] (pos? (:count p1__86070#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86071#] (Math/sin (* p1__86071# 0.3))) (range 30))}))
