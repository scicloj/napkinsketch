...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__69659#] (= 50 (:n-points p1__69659#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__69660#] (< (:lo p1__69660#) (:hi p1__69660#)))
      bars)
     (every? (fn* [p1__69661#] (pos? (:count p1__69661#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__69662#] (Math/sin (* p1__69662# 0.3))) (range 30))}))
