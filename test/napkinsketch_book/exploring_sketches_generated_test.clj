...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__81849#] (= 50 (:n-points p1__81849#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__81850#] (< (:lo p1__81850#) (:hi p1__81850#)))
      bars)
     (every? (fn* [p1__81851#] (pos? (:count p1__81851#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__81852#] (Math/sin (* p1__81852# 0.3))) (range 30))}))
