...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76167#] (= 50 (:n-points p1__76167#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76168#] (< (:lo p1__76168#) (:hi p1__76168#)))
      bars)
     (every? (fn* [p1__76169#] (pos? (:count p1__76169#))) bars)))
   v66_l199)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__76170#] (Math/sin (* p1__76170# 0.3)))
     (range 30))})))
