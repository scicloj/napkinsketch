...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__103164#] (= 50 (:n-points p1__103164#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__103165#] (< (:lo p1__103165#) (:hi p1__103165#)))
      bars)
     (every? (fn* [p1__103166#] (pos? (:count p1__103166#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__103167#] (Math/sin (* p1__103167# 0.3)))
     (range 30))})))
