...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__94652#] (= 50 (:n-points p1__94652#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__94653#] (< (:lo p1__94653#) (:hi p1__94653#)))
      bars)
     (every? (fn* [p1__94654#] (pos? (:count p1__94654#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__94655#] (Math/sin (* p1__94655# 0.3)))
     (range 30))})))
