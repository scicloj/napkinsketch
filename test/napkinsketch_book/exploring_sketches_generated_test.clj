...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__98832#] (= 50 (:n-points p1__98832#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__98833#] (< (:lo p1__98833#) (:hi p1__98833#)))
      bars)
     (every? (fn* [p1__98834#] (pos? (:count p1__98834#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__98835#] (Math/sin (* p1__98835# 0.3)))
     (range 30))})))
