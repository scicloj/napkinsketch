...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__100490#] (= 50 (:n-points p1__100490#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__100491#] (< (:lo p1__100491#) (:hi p1__100491#)))
      bars)
     (every? (fn* [p1__100492#] (pos? (:count p1__100492#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__100493#] (Math/sin (* p1__100493# 0.3)))
    (range 30))}))
