...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__81085#] (= 50 (:n-points p1__81085#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__81086#] (< (:lo p1__81086#) (:hi p1__81086#)))
      bars)
     (every? (fn* [p1__81087#] (pos? (:count p1__81087#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__81088#] (Math/sin (* p1__81088# 0.3))) (range 30))}))
