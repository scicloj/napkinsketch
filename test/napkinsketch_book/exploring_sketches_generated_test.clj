...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__92383#] (= 50 (:n-points p1__92383#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__92384#] (< (:lo p1__92384#) (:hi p1__92384#)))
      bars)
     (every? (fn* [p1__92385#] (pos? (:count p1__92385#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__92386#] (Math/sin (* p1__92386# 0.3)))
     (range 30))})))
