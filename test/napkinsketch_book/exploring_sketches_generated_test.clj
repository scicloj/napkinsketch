...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__511572#] (= 50 (:n-points p1__511572#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__511573#] (< (:lo p1__511573#) (:hi p1__511573#)))
      bars)
     (every? (fn* [p1__511574#] (pos? (:count p1__511574#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__511575#] (Math/sin (* p1__511575# 0.3)))
    (range 30))}))
