...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__152929#] (= 50 (:n-points p1__152929#))) gs)))
   v50_l164)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__152930#] (< (:lo p1__152930#) (:hi p1__152930#)))
      bars)
     (every? (fn* [p1__152931#] (pos? (:count p1__152931#))) bars)))
   v75_l231)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__152932#] (Math/sin (* p1__152932# 0.3)))
    (range 30))}))
