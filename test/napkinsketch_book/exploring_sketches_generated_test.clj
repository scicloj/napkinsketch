...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__95848#] (= 50 (:n-points p1__95848#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__95849#] (< (:lo p1__95849#) (:hi p1__95849#)))
      bars)
     (every? (fn* [p1__95850#] (pos? (:count p1__95850#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__95851#] (Math/sin (* p1__95851# 0.3))) (range 30))}))
