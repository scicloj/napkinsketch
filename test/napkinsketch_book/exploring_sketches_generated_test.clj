...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87752#] (= 50 (:n-points p1__87752#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87753#] (< (:lo p1__87753#) (:hi p1__87753#)))
      bars)
     (every? (fn* [p1__87754#] (pos? (:count p1__87754#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__87755#] (Math/sin (* p1__87755# 0.3)))
     (range 30))})))
