...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__91250#] (= 50 (:n-points p1__91250#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__91251#] (< (:lo p1__91251#) (:hi p1__91251#)))
      bars)
     (every? (fn* [p1__91252#] (pos? (:count p1__91252#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__91253#] (Math/sin (* p1__91253# 0.3))) (range 30))}))
