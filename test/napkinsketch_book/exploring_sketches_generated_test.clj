...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__337142#] (= 50 (:n-points p1__337142#))) gs)))
   v51_l149)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__337143#] (< (:lo p1__337143#) (:hi p1__337143#)))
      bars)
     (every? (fn* [p1__337144#] (pos? (:count p1__337144#))) bars)))
   v63_l183)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__337145#] (Math/sin (* p1__337145# 0.3)))
     (range 30))})))
