...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76533#] (= 50 (:n-points p1__76533#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76534#] (< (:lo p1__76534#) (:hi p1__76534#)))
      bars)
     (every? (fn* [p1__76535#] (pos? (:count p1__76535#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__76536#] (Math/sin (* p1__76536# 0.3))) (range 30))}))
