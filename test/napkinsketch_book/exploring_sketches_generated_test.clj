...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86942#] (= 50 (:n-points p1__86942#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86943#] (< (:lo p1__86943#) (:hi p1__86943#)))
      bars)
     (every? (fn* [p1__86944#] (pos? (:count p1__86944#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86945#] (Math/sin (* p1__86945# 0.3))) (range 30))}))
