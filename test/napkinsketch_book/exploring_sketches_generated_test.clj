...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__78712#] (= 50 (:n-points p1__78712#))) gs)))
   v50_l164)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__78713#] (< (:lo p1__78713#) (:hi p1__78713#)))
      bars)
     (every? (fn* [p1__78714#] (pos? (:count p1__78714#))) bars)))
   v75_l231)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__78715#] (Math/sin (* p1__78715# 0.3))) (range 30))}))
