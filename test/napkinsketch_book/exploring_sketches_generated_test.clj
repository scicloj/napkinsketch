...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__90481#] (= 50 (:n-points p1__90481#))) gs)))
   v50_l172)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__90482#] (< (:lo p1__90482#) (:hi p1__90482#)))
      bars)
     (every? (fn* [p1__90483#] (pos? (:count p1__90483#))) bars)))
   v75_l244)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__90484#] (Math/sin (* p1__90484# 0.3))) (range 30))}))
