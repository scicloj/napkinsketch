...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__122478#] (= 50 (:n-points p1__122478#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__122479#] (< (:lo p1__122479#) (:hi p1__122479#)))
      bars)
     (every? (fn* [p1__122480#] (pos? (:count p1__122480#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__122481#] (Math/sin (* p1__122481# 0.3)))
    (range 30))}))
