...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80769#] (= 50 (:n-points p1__80769#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80770#] (< (:lo p1__80770#) (:hi p1__80770#)))
      bars)
     (every? (fn* [p1__80771#] (pos? (:count p1__80771#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80772#] (Math/sin (* p1__80772# 0.3))) (range 30))}))
