...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76280#] (= 50 (:n-points p1__76280#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76281#] (< (:lo p1__76281#) (:hi p1__76281#)))
      bars)
     (every? (fn* [p1__76282#] (pos? (:count p1__76282#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__76283#] (Math/sin (* p1__76283# 0.3))) (range 30))}))
