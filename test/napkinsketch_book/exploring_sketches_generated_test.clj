...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80738#] (= 50 (:n-points p1__80738#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80739#] (< (:lo p1__80739#) (:hi p1__80739#)))
      bars)
     (every? (fn* [p1__80740#] (pos? (:count p1__80740#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80741#] (Math/sin (* p1__80741# 0.3))) (range 30))}))
