...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__69521#] (= 50 (:n-points p1__69521#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__69522#] (< (:lo p1__69522#) (:hi p1__69522#)))
      bars)
     (every? (fn* [p1__69523#] (pos? (:count p1__69523#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__69524#] (Math/sin (* p1__69524# 0.3))) (range 30))}))
