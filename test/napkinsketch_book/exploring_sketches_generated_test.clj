...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86248#] (= 50 (:n-points p1__86248#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86249#] (< (:lo p1__86249#) (:hi p1__86249#)))
      bars)
     (every? (fn* [p1__86250#] (pos? (:count p1__86250#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86251#] (Math/sin (* p1__86251# 0.3))) (range 30))}))
