...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__101935#] (= 50 (:n-points p1__101935#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__101936#] (< (:lo p1__101936#) (:hi p1__101936#)))
      bars)
     (every? (fn* [p1__101937#] (pos? (:count p1__101937#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__101938#] (Math/sin (* p1__101938# 0.3)))
    (range 30))}))
