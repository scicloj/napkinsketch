...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__81313#] (= 50 (:n-points p1__81313#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__81314#] (< (:lo p1__81314#) (:hi p1__81314#)))
      bars)
     (every? (fn* [p1__81315#] (pos? (:count p1__81315#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__81316#] (Math/sin (* p1__81316# 0.3))) (range 30))}))
