...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__100900#] (= 50 (:n-points p1__100900#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__100901#] (< (:lo p1__100901#) (:hi p1__100901#)))
      bars)
     (every? (fn* [p1__100902#] (pos? (:count p1__100902#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__100903#] (Math/sin (* p1__100903# 0.3)))
    (range 30))}))
