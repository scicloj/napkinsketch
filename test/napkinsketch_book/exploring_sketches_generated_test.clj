...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__84819#] (= 50 (:n-points p1__84819#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__84820#] (< (:lo p1__84820#) (:hi p1__84820#)))
      bars)
     (every? (fn* [p1__84821#] (pos? (:count p1__84821#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__84822#] (Math/sin (* p1__84822# 0.3))) (range 30))}))
