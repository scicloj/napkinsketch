...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__143782#] (= 50 (:n-points p1__143782#))) gs)))
   v50_l164)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__143783#] (< (:lo p1__143783#) (:hi p1__143783#)))
      bars)
     (every? (fn* [p1__143784#] (pos? (:count p1__143784#))) bars)))
   v75_l231)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__143785#] (Math/sin (* p1__143785# 0.3)))
    (range 30))}))
