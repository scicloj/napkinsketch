...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__149107#] (= 50 (:n-points p1__149107#))) gs)))
   v50_l164)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__149108#] (< (:lo p1__149108#) (:hi p1__149108#)))
      bars)
     (every? (fn* [p1__149109#] (pos? (:count p1__149109#))) bars)))
   v75_l231)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__149110#] (Math/sin (* p1__149110# 0.3)))
    (range 30))}))
