...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__90872#] (= 50 (:n-points p1__90872#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__90873#] (< (:lo p1__90873#) (:hi p1__90873#)))
      bars)
     (every? (fn* [p1__90874#] (pos? (:count p1__90874#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__90875#] (Math/sin (* p1__90875# 0.3))) (range 30))}))
