...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__111976#] (= 50 (:n-points p1__111976#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__111977#] (< (:lo p1__111977#) (:hi p1__111977#)))
      bars)
     (every? (fn* [p1__111978#] (pos? (:count p1__111978#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__111979#] (Math/sin (* p1__111979# 0.3)))
     (range 30))})))
