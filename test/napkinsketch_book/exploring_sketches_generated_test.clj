...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__114122#] (= 50 (:n-points p1__114122#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__114123#] (< (:lo p1__114123#) (:hi p1__114123#)))
      bars)
     (every? (fn* [p1__114124#] (pos? (:count p1__114124#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__114125#] (Math/sin (* p1__114125# 0.3)))
    (range 30))}))
