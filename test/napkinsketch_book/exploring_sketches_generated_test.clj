...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__78464#] (= 50 (:n-points p1__78464#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__78465#] (< (:lo p1__78465#) (:hi p1__78465#)))
      bars)
     (every? (fn* [p1__78466#] (pos? (:count p1__78466#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__78467#] (Math/sin (* p1__78467# 0.3))) (range 30))}))
