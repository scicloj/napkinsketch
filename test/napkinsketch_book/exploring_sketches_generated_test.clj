...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__395518#] (= 50 (:n-points p1__395518#))) gs)))
   v49_l176)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__395519#] (< (:lo p1__395519#) (:hi p1__395519#)))
      bars)
     (every? (fn* [p1__395520#] (pos? (:count p1__395520#))) bars)))
   v74_l247)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__395521#] (Math/sin (* p1__395521# 0.3)))
    (range 30))}))
