...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__81400#] (= 50 (:n-points p1__81400#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__81401#] (< (:lo p1__81401#) (:hi p1__81401#)))
      bars)
     (every? (fn* [p1__81402#] (pos? (:count p1__81402#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__81403#] (Math/sin (* p1__81403# 0.3))) (range 30))}))
