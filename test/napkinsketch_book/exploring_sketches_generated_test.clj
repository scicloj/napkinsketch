...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89142#] (= 50 (:n-points p1__89142#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89143#] (< (:lo p1__89143#) (:hi p1__89143#)))
      bars)
     (every? (fn* [p1__89144#] (pos? (:count p1__89144#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89145#] (Math/sin (* p1__89145# 0.3))) (range 30))}))
