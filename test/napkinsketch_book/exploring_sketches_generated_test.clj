...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__69675#] (= 50 (:n-points p1__69675#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__69676#] (< (:lo p1__69676#) (:hi p1__69676#)))
      bars)
     (every? (fn* [p1__69677#] (pos? (:count p1__69677#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__69678#] (Math/sin (* p1__69678# 0.3))) (range 30))}))
