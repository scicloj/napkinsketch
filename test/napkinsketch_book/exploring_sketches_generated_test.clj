...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__95648#] (= 50 (:n-points p1__95648#))) gs)))
   v53_l161)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__95649#] (< (:lo p1__95649#) (:hi p1__95649#)))
      bars)
     (every? (fn* [p1__95650#] (pos? (:count p1__95650#))) bars)))
   v74_l221)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__95651#] (Math/sin (* p1__95651# 0.3)))
     (range 30))})))
