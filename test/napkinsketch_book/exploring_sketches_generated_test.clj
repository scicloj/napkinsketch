...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80699#] (= 50 (:n-points p1__80699#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80700#] (< (:lo p1__80700#) (:hi p1__80700#)))
      bars)
     (every? (fn* [p1__80701#] (pos? (:count p1__80701#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80702#] (Math/sin (* p1__80702# 0.3))) (range 30))}))
