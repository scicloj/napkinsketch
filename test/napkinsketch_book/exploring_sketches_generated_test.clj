...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__444277#] (= 50 (:n-points p1__444277#))) gs)))
   v51_l149)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__444278#] (< (:lo p1__444278#) (:hi p1__444278#)))
      bars)
     (every? (fn* [p1__444279#] (pos? (:count p1__444279#))) bars)))
   v63_l183)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__444280#] (Math/sin (* p1__444280# 0.3)))
     (range 30))})))
