...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87771#] (= 50 (:n-points p1__87771#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87772#] (< (:lo p1__87772#) (:hi p1__87772#)))
      bars)
     (every? (fn* [p1__87773#] (pos? (:count p1__87773#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__87774#] (Math/sin (* p1__87774# 0.3))) (range 30))}))
