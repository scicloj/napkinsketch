...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__72610#] (= 50 (:n-points p1__72610#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__72611#] (< (:lo p1__72611#) (:hi p1__72611#)))
      bars)
     (every? (fn* [p1__72612#] (pos? (:count p1__72612#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__72613#] (Math/sin (* p1__72613# 0.3))) (range 30))}))
