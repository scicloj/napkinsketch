...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__119647#] (= 50 (:n-points p1__119647#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__119648#] (< (:lo p1__119648#) (:hi p1__119648#)))
      bars)
     (every? (fn* [p1__119649#] (pos? (:count p1__119649#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__119650#] (Math/sin (* p1__119650# 0.3)))
    (range 30))}))
