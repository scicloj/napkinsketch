...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__94689#] (= 50 (:n-points p1__94689#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__94690#] (< (:lo p1__94690#) (:hi p1__94690#)))
      bars)
     (every? (fn* [p1__94691#] (pos? (:count p1__94691#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__94692#] (Math/sin (* p1__94692# 0.3))) (range 30))}))
