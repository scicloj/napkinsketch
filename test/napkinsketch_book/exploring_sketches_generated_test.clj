...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__99377#] (= 50 (:n-points p1__99377#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__99378#] (< (:lo p1__99378#) (:hi p1__99378#)))
      bars)
     (every? (fn* [p1__99379#] (pos? (:count p1__99379#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__99380#] (Math/sin (* p1__99380# 0.3))) (range 30))}))
