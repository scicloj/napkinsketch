...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80767#] (= 50 (:n-points p1__80767#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80768#] (< (:lo p1__80768#) (:hi p1__80768#)))
      bars)
     (every? (fn* [p1__80769#] (pos? (:count p1__80769#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80770#] (Math/sin (* p1__80770# 0.3))) (range 30))}))
