...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85187#] (= 50 (:n-points p1__85187#))) gs)))
   v51_l149)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85188#] (< (:lo p1__85188#) (:hi p1__85188#)))
      bars)
     (every? (fn* [p1__85189#] (pos? (:count p1__85189#))) bars)))
   v63_l183)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__85190#] (Math/sin (* p1__85190# 0.3)))
     (range 30))})))
