...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__77390#] (= 50 (:n-points p1__77390#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__77391#] (< (:lo p1__77391#) (:hi p1__77391#)))
      bars)
     (every? (fn* [p1__77392#] (pos? (:count p1__77392#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__77393#] (Math/sin (* p1__77393# 0.3))) (range 30))}))
