...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__127376#] (= 50 (:n-points p1__127376#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__127377#] (< (:lo p1__127377#) (:hi p1__127377#)))
      bars)
     (every? (fn* [p1__127378#] (pos? (:count p1__127378#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__127379#] (Math/sin (* p1__127379# 0.3)))
    (range 30))}))
