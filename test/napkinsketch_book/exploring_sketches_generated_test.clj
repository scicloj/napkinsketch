...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__69668#] (= 50 (:n-points p1__69668#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__69669#] (< (:lo p1__69669#) (:hi p1__69669#)))
      bars)
     (every? (fn* [p1__69670#] (pos? (:count p1__69670#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__69671#] (Math/sin (* p1__69671# 0.3))) (range 30))}))
