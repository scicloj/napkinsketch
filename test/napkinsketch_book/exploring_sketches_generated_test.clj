...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76449#] (= 50 (:n-points p1__76449#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76450#] (< (:lo p1__76450#) (:hi p1__76450#)))
      bars)
     (every? (fn* [p1__76451#] (pos? (:count p1__76451#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__76452#] (Math/sin (* p1__76452# 0.3))) (range 30))}))
