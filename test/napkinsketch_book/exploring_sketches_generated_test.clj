...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76503#] (= 50 (:n-points p1__76503#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76504#] (< (:lo p1__76504#) (:hi p1__76504#)))
      bars)
     (every? (fn* [p1__76505#] (pos? (:count p1__76505#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__76506#] (Math/sin (* p1__76506# 0.3))) (range 30))}))
