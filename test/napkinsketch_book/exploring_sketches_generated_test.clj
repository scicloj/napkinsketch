...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__76529#] (= 50 (:n-points p1__76529#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__76530#] (< (:lo p1__76530#) (:hi p1__76530#)))
      bars)
     (every? (fn* [p1__76531#] (pos? (:count p1__76531#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv (fn* [p1__76532#] (Math/sin (* p1__76532# 0.3))) (range 30))}))
