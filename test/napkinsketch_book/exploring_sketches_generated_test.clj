...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80547#] (= 50 (:n-points p1__80547#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80548#] (< (:lo p1__80548#) (:hi p1__80548#)))
      bars)
     (every? (fn* [p1__80549#] (pos? (:count p1__80549#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80550#] (Math/sin (* p1__80550# 0.3))) (range 30))}))
