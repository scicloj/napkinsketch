...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__75026#] (= 50 (:n-points p1__75026#))) gs)))
   v53_l153)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__75027#] (< (:lo p1__75027#) (:hi p1__75027#)))
      bars)
     (every? (fn* [p1__75028#] (pos? (:count p1__75028#))) bars)))
   v66_l189)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__75029#] (Math/sin (* p1__75029# 0.3)))
     (range 30))})))
...
(def
 v153_l458
 (mapv
  (fn* [p1__75030#] (select-keys p1__75030# [:row :col :col-label]))
  (:panels faceted-sk)))
...
(def
 ...
 (mapv
  (fn*
   [p1__75031#]
   (select-keys p1__75031# [:col-label :x-domain :y-domain]))
  (:panels faceted-sk)))
