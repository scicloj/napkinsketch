...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__133398#] (= 50 (:n-points p1__133398#))) gs)))
   v50_l164)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__133399#] (< (:lo p1__133399#) (:hi p1__133399#)))
      bars)
     (every? (fn* [p1__133400#] (pos? (:count p1__133400#))) bars)))
   v75_l232)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__133401#] (Math/sin (* p1__133401# 0.3)))
     (range 30))})))
