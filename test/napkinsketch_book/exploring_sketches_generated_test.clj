...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80771#] (= 50 (:n-points p1__80771#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80772#] (< (:lo p1__80772#) (:hi p1__80772#)))
      bars)
     (every? (fn* [p1__80773#] (pos? (:count p1__80773#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80774#] (Math/sin (* p1__80774# 0.3))) (range 30))}))
