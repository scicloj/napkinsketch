...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__80555#] (= 50 (:n-points p1__80555#))) gs)))
   v49_l167)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__80556#] (< (:lo p1__80556#) (:hi p1__80556#)))
      bars)
     (every? (fn* [p1__80557#] (pos? (:count p1__80557#))) bars)))
   v74_l238)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__80558#] (Math/sin (* p1__80558# 0.3))) (range 30))}))
