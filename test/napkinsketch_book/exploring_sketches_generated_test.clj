...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__73484#] (= 50 (:n-points p1__73484#))) gs)))
   v51_l149)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__73485#] (< (:lo p1__73485#) (:hi p1__73485#)))
      bars)
     (every? (fn* [p1__73486#] (pos? (:count p1__73486#))) bars)))
   v63_l183)))
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :y
    (mapv
     (fn* [p1__73487#] (Math/sin (* p1__73487# 0.3)))
     (range 30))})))
