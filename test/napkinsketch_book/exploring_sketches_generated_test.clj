...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__131068#] (= 50 (:n-points p1__131068#))) gs)))
   v50_l170)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__131069#] (< (:lo p1__131069#) (:hi p1__131069#)))
      bars)
     (every? (fn* [p1__131070#] (pos? (:count p1__131070#))) bars)))
   v75_l241)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (mapv
    (fn* [p1__131071#] (Math/sin (* p1__131071# 0.3)))
    (range 30))}))
