...
(def
 ...
 (->
  (rdatasets/gapminder-gapminder)
  (tc/select-rows (fn* [p1__186211#] (= 2007 (:year p1__186211#))))
...
(def
 ...
 (->
  (rdatasets/lme4-sleepstudy)
  (tc/select-rows
   (fn* [p1__186214#] (= "308" (str (:subject p1__186214#)))))
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__186215#] (= 2007 (:year p1__186215#))))
  (sk/lay-point
   :gdp-percap
   :life-exp
   ...
   (tc/add-column
    ...
    (fn
     ...
     (map
      (fn*
       [p1__186216#]
       (get {5 "May", 6 "Jun", 7 "Jul", 8 "Aug", 9 "Sep"} p1__186216#))
      (ds :month)))))))
...
(def
 ...
 (->
  (tc/dataset
   {:row (mapcat (fn* [p1__186217#] (repeat 6 p1__186217#)) (range 6)),
    :col (flatten (repeat 6 (range 6))),
    :value
    (map
     (fn* [p1__186218#] (Math/sin (* p1__186218# 0.5)))
     (range 36))})
...
(def
 ...
 (->
  (tc/select-rows
   (rdatasets/gapminder-gapminder)
   (fn* [p1__186219#] (= 2007 (:year p1__186219#))))
