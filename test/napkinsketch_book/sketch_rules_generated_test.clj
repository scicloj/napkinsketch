...
(deftest
 t20_l147
 (is ((fn [v] (= 150 (:points (sk/svg-summary v)))) v19_l144)))
...
(deftest
 t38_l233
 (is ((fn [m] (= :species (get-in m [:shared :color]))) v37_l227)))
...
(def v62_l341 (-> {:x [1 2 3], :y [4 5 6]} sk/lay-point))


(deftest
 t63_l344
 (is ((fn [v] (= 3 (:points (sk/svg-summary v)))) v62_l341)))
...
(def v87_l478 (select-keys scale-plan [:x-label :y-label]))
