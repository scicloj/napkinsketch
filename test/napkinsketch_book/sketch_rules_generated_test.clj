...
(def
 ...
 (defn
  ...
  (->
   ...
   (update
    :views
    (partial mapv (fn* [p1__80985#] (dissoc p1__80985# :data))))
   kind/pprint)))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (= 2 (:panels s))
      (= 300 (:points s))
      (every? (fn* [p1__80986#] (= :species (:color p1__80986#))) d))))
   v69_l445)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__80987#]
        (when (= :rule-h (:method p1__80987#)) p1__80987#))
       layers)]
     (and (some? rule) (= 3.0 (get-in rule [:mapping :intercept])))))
   v106_l670)))
...
(deftest
 t110_l690
 (is ((fn [v] (= 3 (count (:panels (sk/plan v))))) v109_l686)))
...
(deftest
 t112_l697
 (is ((fn [m] (= :species (get-in m [:opts :facet-col]))) v111_l692)))
...
(deftest
 t114_l704
 (is ((fn [v] (= 9 (count (:panels (sk/plan v))))) v113_l700)))
...
(def v121_l763 (sk-summary assembly-sketch))
...
(deftest
 t130_l816
 (is
  ((fn [v] (let [p (sk/plan v)] (= 2 (count (:panels p))))) v129_l812)))
...
(deftest
 t140_l862
 (is
  ((fn [v] (let [p (sk/plan v)] (= 3 (count (:panels p))))) v139_l858)))
