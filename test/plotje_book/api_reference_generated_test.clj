...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__84575#] (Math/sin (* p1__84575# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__84577#] (bit-and p1__84577# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__84578#] (bit-and p1__84578# 255)) (vec bs))))))
