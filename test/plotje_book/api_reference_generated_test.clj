...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86572#] (Math/sin (* p1__86572# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__86574#] (bit-and p1__86574# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__86575#] (bit-and p1__86575# 255)) (vec bs))))))
