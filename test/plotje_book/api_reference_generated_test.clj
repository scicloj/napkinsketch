...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__187018#] (Math/sin (* p1__187018# 0.3)))
    (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__187020#] (bit-and p1__187020# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__187021#] (bit-and p1__187021# 255)) (vec bs))))))
