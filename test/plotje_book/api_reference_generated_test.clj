...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87363#] (Math/sin (* p1__87363# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__87365#] (bit-and p1__87365# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__87366#] (bit-and p1__87366# 255)) (vec bs))))))
