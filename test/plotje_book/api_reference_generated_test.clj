...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__93709#] (Math/sin (* p1__93709# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__93711#] (bit-and p1__93711# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__93712#] (bit-and p1__93712# 255)) (vec bs))))))
