...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__94428#] (Math/sin (* p1__94428# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__94430#] (bit-and p1__94430# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__94431#] (bit-and p1__94431# 255)) (vec bs))))))
