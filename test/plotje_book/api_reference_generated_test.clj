...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__78410#] (Math/sin (* p1__78410# 0.3))) (range 30))}))
...
(deftest t221_l647 (is ((fn [n] (= 37 n)) v220_l645)))
...
(deftest t224_l653 (is ((fn [n] (= 13 n)) v223_l651)))
