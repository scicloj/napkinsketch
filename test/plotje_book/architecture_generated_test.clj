    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__89027#] (= :petal-length (:x p1__89027#)))
        layers)
       (every?
        (fn* [p1__89028#] (= :petal-width (:y p1__89028#)))
        layers)
       (every?
        (fn* [p1__89029#] (= :species (:color p1__89029#)))
        layers)))
     (= {} (:opts d))))
   v14_l200)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__89030#]
       (.startsWith (.getName (class p1__89030#)) "membrane.ui."))
      (:drawables v))))
   v27_l258)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__89031#] (.startsWith p1__89031# "rgb"))
         (:colors s)))))))
   v40_l436)))
