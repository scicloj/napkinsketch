    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__96084#] (= :petal-length (:x p1__96084#)))
        layers)
       (every?
        (fn* [p1__96085#] (= :petal-width (:y p1__96085#)))
        layers)
       (every?
        (fn* [p1__96086#] (= :species (:color p1__96086#)))
        layers)))
     (= {} (:opts d))))
   v14_l193)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__96087#]
       (.startsWith (.getName (class p1__96087#)) "membrane.ui."))
      v)))
   v27_l247)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__96088#] (.startsWith p1__96088# "rgb"))
         (:colors s)))))))
   v40_l418)))
