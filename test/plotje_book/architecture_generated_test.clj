    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__87641#] (= :petal-length (:x p1__87641#)))
        layers)
       (every?
        (fn* [p1__87642#] (= :petal-width (:y p1__87642#)))
        layers)
       (every?
        (fn* [p1__87643#] (= :species (:color p1__87643#)))
        layers)))
     (= {} (:opts d))))
   v14_l200)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__87644#]
       (.startsWith (.getName (class p1__87644#)) "membrane.ui."))
      (:drawables v))))
   v27_l258)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__87645#] (.startsWith p1__87645# "rgb"))
         (:colors s)))))))
   v40_l436)))
