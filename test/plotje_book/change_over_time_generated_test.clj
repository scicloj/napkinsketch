...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__84042#] (Math/sin (* p1__84042# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :sin
    (map (fn* [p1__84043#] (Math/sin (* p1__84043# 0.3))) (range 30)),
    :cos
    (map
     (fn* [p1__84044#] (Math/cos (* p1__84044# 0.3)))
     (range 30))})))
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__84045#] (Math/sin (* p1__84045# 0.3))) (range 30))}
  (pj/lay-area :x :y)))
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__84046#] (re-find #"[A-Z][a-z]{2}" p1__84046#))
       tick-labels))))
   v35_l167)))
