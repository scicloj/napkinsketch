...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__91913#] (Math/sin (* p1__91913# 0.3))) (range 30))}))
...
(def
 ...
 (def
  ...
  (tc/dataset
   {:x (range 30),
    :sin
    (map (fn* [p1__91914#] (Math/sin (* p1__91914# 0.3))) (range 30)),
    :cos
    (map
     (fn* [p1__91915#] (Math/cos (* p1__91915# 0.3)))
     (range 30))})))
...
(def
 ...
 (->
  {:x (range 30),
   :y
   (map (fn* [p1__91916#] (Math/sin (* p1__91916# 0.3))) (range 30))}
  (pj/lay-area :x :y)))
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__91917#] (re-find #"[A-Z][a-z]{2}" p1__91917#))
       tick-labels))))
   v35_l167)))
