 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__98987#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__98987#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__98988#] (= "virginica" p1__98988#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__98989#] (Math/sin (/ p1__98989# 3.0))) (range 20)),
   :change (map (fn* [p1__98990#] (- p1__98990# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__98991#]
     (+ (* 3 p1__98991#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
