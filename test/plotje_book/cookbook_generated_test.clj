 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__96262#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__96262#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__96263#] (= "virginica" p1__96263#))
       (:texts s)))))
   v67_l303)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__96264#] (Math/sin (/ p1__96264# 3.0))) (range 20)),
   :change (map (fn* [p1__96265#] (- p1__96265# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__96266#]
     (+ (* 3 p1__96266#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
