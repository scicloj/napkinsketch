 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__83662#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__83662#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__83663#] (= "virginica" p1__83663#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__83664#] (Math/sin (/ p1__83664# 3.0))) (range 20)),
   :change (map (fn* [p1__83665#] (- p1__83665# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__83666#]
     (+ (* 3 p1__83666#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
