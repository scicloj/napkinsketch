 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__73947#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__73947#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__73948#] (= "virginica" p1__73948#))
       (:texts s)))))
   v67_l303)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__73949#] (Math/sin (/ p1__73949# 3.0))) (range 20)),
   :change (map (fn* [p1__73950#] (- p1__73950# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__73951#]
     (+ (* 3 p1__73951#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
