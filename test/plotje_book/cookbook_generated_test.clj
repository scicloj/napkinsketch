 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__78943#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__78943#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__78944#] (= "virginica" p1__78944#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__78945#] (Math/sin (/ p1__78945# 3.0))) (range 20)),
   :change (map (fn* [p1__78946#] (- p1__78946# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__78947#]
     (+ (* 3 p1__78947#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
