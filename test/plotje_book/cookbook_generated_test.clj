 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__86057#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__86057#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__86058#] (= "virginica" p1__86058#))
       (:texts s)))))
   v70_l325)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__86059#] (Math/sin (/ p1__86059# 3.0))) (range 20)),
   :change (map (fn* [p1__86060#] (- p1__86060# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__86061#]
     (+ (* 3 p1__86061#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
