 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__561909#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__561909#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__561910#] (= "virginica" p1__561910#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__561911#] (Math/sin (/ p1__561911# 3.0))) (range 20)),
   :change (map (fn* [p1__561912#] (- p1__561912# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__561913#]
     (+ (* 3 p1__561913#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
