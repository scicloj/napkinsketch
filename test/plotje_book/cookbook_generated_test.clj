 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__72210#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__72210#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__72211#] (= "virginica" p1__72211#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__72212#] (Math/sin (/ p1__72212# 3.0))) (range 20)),
   :change (map (fn* [p1__72213#] (- p1__72213# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__72214#]
     (+ (* 3 p1__72214#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
