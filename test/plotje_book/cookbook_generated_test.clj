 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__89626#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__89626#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__89627#] (= "virginica" p1__89627#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__89628#] (Math/sin (/ p1__89628# 3.0))) (range 20)),
   :change (map (fn* [p1__89629#] (- p1__89629# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__89630#]
     (+ (* 3 p1__89630#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
