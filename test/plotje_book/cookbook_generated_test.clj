 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__83084#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__83084#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__83085#] (= "virginica" p1__83085#))
       (:texts s)))))
   v67_l303)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__83086#] (Math/sin (/ p1__83086# 3.0))) (range 20)),
   :change (map (fn* [p1__83087#] (- p1__83087# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__83088#]
     (+ (* 3 p1__83088#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
