 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__121113#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__121113#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__121114#] (= "virginica" p1__121114#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__121115#] (Math/sin (/ p1__121115# 3.0))) (range 20)),
   :change (map (fn* [p1__121116#] (- p1__121116# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__121117#]
     (+ (* 3 p1__121117#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__121118#] (bit-and p1__121118# 255)) (vec bs))))))
