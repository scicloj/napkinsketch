 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__185813#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__185813#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__185814#] (= "virginica" p1__185814#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__185815#] (Math/sin (/ p1__185815# 3.0))) (range 20)),
   :change (map (fn* [p1__185816#] (- p1__185816# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__185817#]
     (+ (* 3 p1__185817#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__185818#] (bit-and p1__185818# 255)) (vec bs))))))
