 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__82421#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__82421#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__82422#] (= "virginica" p1__82422#))
       (:texts s)))))
   v67_l303)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__82423#] (Math/sin (/ p1__82423# 3.0))) (range 20)),
   :change (map (fn* [p1__82424#] (- p1__82424# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__82425#]
     (+ (* 3 p1__82425#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
