 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__525111#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__525111#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__525112#] (= "virginica" p1__525112#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__525113#] (Math/sin (/ p1__525113# 3.0))) (range 20)),
   :change (map (fn* [p1__525114#] (- p1__525114# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__525115#]
     (+ (* 3 p1__525115#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
