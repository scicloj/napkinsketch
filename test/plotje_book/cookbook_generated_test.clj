 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__84144#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__84144#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__84145#] (= "virginica" p1__84145#))
       (:texts s)))))
   v70_l325)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__84146#] (Math/sin (/ p1__84146# 3.0))) (range 20)),
   :change (map (fn* [p1__84147#] (- p1__84147# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__84148#]
     (+ (* 3 p1__84148#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__84149#] (bit-and p1__84149# 255)) (vec bs))))))
