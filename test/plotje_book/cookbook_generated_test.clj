 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__87062#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__87062#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__87063#] (= "virginica" p1__87063#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__87064#] (Math/sin (/ p1__87064# 3.0))) (range 20)),
   :change (map (fn* [p1__87065#] (- p1__87065# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__87066#]
     (+ (* 3 p1__87066#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
