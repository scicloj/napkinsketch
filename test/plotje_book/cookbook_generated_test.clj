 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__234583#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__234583#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__234584#] (= "virginica" p1__234584#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__234585#] (Math/sin (/ p1__234585# 3.0))) (range 20)),
   :change (map (fn* [p1__234586#] (- p1__234586# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__234587#]
     (+ (* 3 p1__234587#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__234588#] (bit-and p1__234588# 255)) (vec bs))))))
