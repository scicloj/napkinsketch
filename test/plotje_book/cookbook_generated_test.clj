 ...
 (def
  ...
  {:date ts-dates,
   ...
   (map
    (fn*
     [p1__84967#]
     (+ 100.0 (* 30.0 (Math/sin (* (double p1__84967#) 0.12)))))
    (range 52))}))
  ...
  ((fn
    ...
    (let
     ...
     (and
      (pos? (:points s))
      (some
       (fn* [p1__84968#] (= "virginica" p1__84968#))
       (:texts s)))))
   v67_l305)))
...
(def
 ...
 (->
  {:x (range 20),
   :y
   (map (fn* [p1__84969#] (Math/sin (/ p1__84969# 3.0))) (range 20)),
   :change (map (fn* [p1__84970#] (- p1__84970# 10)) (range 20))}
 ...
 (let
  [r
   ...
   (map
    (fn*
     [p1__84971#]
     (+ (* 3 p1__84971#) 5 (* 2 (- (rng/drandom r) 0.5))))
    xs)]
  (->
   {:x xs, :y ys}
   (pj/lay-point :x :y)
