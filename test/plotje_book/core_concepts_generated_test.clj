...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__125785#] (= "setosa" (:species p1__125785#))))))
...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__125786#] (= "versicolor" (:species p1__125786#))))))
...
(deftest
 t137_l689
 (is ((fn [v] (= 6 (:points (pj/svg-summary v)))) v136_l683)))
...
(deftest
 t143_l718
 (is ((fn [v] (= :species (get-in v [:opts :facet-col]))) v142_l711)))
...
(deftest
 t146_l725
 (is ((fn [v] (= 3 (:panels (pj/svg-summary v)))) v145_l722)))
...
(deftest
 t152_l748
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v151_l742)))
