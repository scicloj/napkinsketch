...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__76983#] (= "setosa" (:species p1__76983#))))))
...
(def
 ...
 (def
  ...
  (tc/select-rows
   (rdatasets/datasets-iris)
   (fn* [p1__76984#] (= "versicolor" (:species p1__76984#))))))
...
(deftest
 t119_l646
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v118_l643)))
...
(deftest
 t122_l653
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v121_l650)))
...
(deftest
 t131_l696
 (is ((fn [v] (pos? (:polygons (pj/svg-summary v)))) v130_l693)))
...
(deftest
 t134_l710
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v133_l706)))
...
(deftest
 t149_l793
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v148_l788)))
...
(deftest
 t155_l825
 (is ((fn [v] (= 150 (:points (pj/svg-summary v)))) v154_l821)))
...
(deftest
 t161_l851
 (is ((fn [v] (= 6 (:points (pj/svg-summary v)))) v160_l845)))
...
(deftest
 t167_l881
 (is ((fn [v] (= :species (get-in v [:opts :facet-col]))) v166_l874)))
...
(deftest
 t170_l888
 (is ((fn [v] (= 3 (:panels (pj/svg-summary v)))) v169_l885)))
...
(deftest
 t176_l911
 (is ((fn [v] (= 2 (:panels (pj/svg-summary v)))) v175_l905)))
