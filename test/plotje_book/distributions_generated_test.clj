  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__185083#] (= "Distribution of Total Bill" p1__185083#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__185084#] (= :boxplot (:mark p1__185084#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__185085#] (= :boxplot (:mark p1__185085#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__185086#] (= :violin (:mark p1__185086#)))
     (:layers panel)))
   cats
