  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__120383#] (= "Distribution of Total Bill" p1__120383#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__120384#] (= :boxplot (:mark p1__120384#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__120385#] (= :boxplot (:mark p1__120385#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__120386#] (= :violin (:mark p1__120386#)))
     (:layers panel)))
   cats
