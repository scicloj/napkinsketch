  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__561179#] (= "Distribution of Total Bill" p1__561179#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__561180#] (= :boxplot (:mark p1__561180#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__561181#] (= :boxplot (:mark p1__561181#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__561182#] (= :violin (:mark p1__561182#)))
     (:layers panel)))
   cats
