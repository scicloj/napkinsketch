  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__84379#] (= "Distribution of Total Bill" p1__84379#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__84380#] (= :boxplot (:mark p1__84380#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__84381#] (= :boxplot (:mark p1__84381#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__84382#] (= :violin (:mark p1__84382#)))
     (:layers panel)))
   cats
