  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__83072#] (= "Distribution of Total Bill" p1__83072#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83073#] (= :boxplot (:mark p1__83073#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83074#] (= :boxplot (:mark p1__83074#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83075#] (= :violin (:mark p1__83075#)))
     (:layers panel)))
   cats
