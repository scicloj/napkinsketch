  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__92730#] (= "Distribution of Total Bill" p1__92730#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [plan
      ...
      (first
       (filter
        (fn* [p1__92731#] (= :boxplot (:mark p1__92731#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__92732#] (= :boxplot (:mark p1__92732#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__92733#] (= :violin (:mark p1__92733#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
