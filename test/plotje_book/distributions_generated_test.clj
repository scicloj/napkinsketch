  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__84445#] (= "Distribution of Total Bill" p1__84445#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [plan
      ...
      (first
       (filter
        (fn* [p1__84446#] (= :boxplot (:mark p1__84446#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__84447#] (= :boxplot (:mark p1__84447#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__84448#] (= :violin (:mark p1__84448#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
