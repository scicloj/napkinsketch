  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__524381#] (= "Distribution of Total Bill" p1__524381#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__524382#] (= :boxplot (:mark p1__524382#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__524383#] (= :boxplot (:mark p1__524383#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__524384#] (= :violin (:mark p1__524384#)))
     (:layers panel)))
   cats
