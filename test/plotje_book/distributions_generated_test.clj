  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__127526#] (= "Distribution of Total Bill" p1__127526#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__127527#] (= :boxplot (:mark p1__127527#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__127528#] (= :boxplot (:mark p1__127528#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__127529#] (= :violin (:mark p1__127529#)))
     (:layers panel)))
   cats
