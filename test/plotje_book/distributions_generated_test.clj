  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__113577#] (= "Distribution of Total Bill" p1__113577#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [plan
      ...
      (first
       (filter
        (fn* [p1__113578#] (= :boxplot (:mark p1__113578#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__113579#] (= :boxplot (:mark p1__113579#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__113580#] (= :violin (:mark p1__113580#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
