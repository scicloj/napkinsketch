  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__83393#] (= "Distribution of Total Bill" p1__83393#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83394#] (= :boxplot (:mark p1__83394#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83395#] (= :boxplot (:mark p1__83395#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__83396#] (= :violin (:mark p1__83396#)))
     (:layers panel)))
   cats
