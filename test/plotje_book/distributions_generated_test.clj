  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__83365#] (= "Distribution of Total Bill" p1__83365#))
       (:texts s)))))
   v12_l53)))
  ...
  ((fn
    ...
    (let
     [plan
      ...
      (first
       (filter
        (fn* [p1__83366#] (= :boxplot (:mark p1__83366#)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__83367#] (= :boxplot (:mark p1__83367#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (first
       (filter
        (fn* [p1__83368#] (= :violin (:mark p1__83368#)))
        (:layers (first (:panels plan)))))]
     (and
      (= 1 (:panels s))
      (= 8 (:polygons s))
