  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__492515#] (= "Distribution of Total Bill" p1__492515#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__492516#] (= :boxplot (:mark p1__492516#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__492517#] (= :boxplot (:mark p1__492517#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__492518#] (= :violin (:mark p1__492518#)))
     (:layers panel)))
   cats
