  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__71480#] (= "Distribution of Total Bill" p1__71480#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__71481#] (= :boxplot (:mark p1__71481#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__71482#] (= :boxplot (:mark p1__71482#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__71483#] (= :violin (:mark p1__71483#)))
     (:layers panel)))
   cats
