  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__132126#] (= "Distribution of Total Bill" p1__132126#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__132127#] (= :boxplot (:mark p1__132127#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__132128#] (= :boxplot (:mark p1__132128#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__132129#] (= :violin (:mark p1__132129#)))
     (:layers panel)))
   cats
