  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (pos? (:polygons s))
      (some
       (fn* [p1__135077#] (= "Distribution of Total Bill" p1__135077#))
       (:texts s)))))
   v12_l53)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__135078#] (= :boxplot (:mark p1__135078#)))
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__135079#] (= :boxplot (:mark p1__135079#)))
     (:layers panel)))
   cats
...
(def
 ...
 (let
  [plan
   ...
   (first
    (filter
     (fn* [p1__135080#] (= :violin (:mark p1__135080#)))
     (:layers panel)))
   cats
