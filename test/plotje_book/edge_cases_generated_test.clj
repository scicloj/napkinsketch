...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__201300#] (keyword (str "cat-" p1__201300#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__201301#] (= "setosa" (p1__201301# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__201302#] (- p1__201302# 10)) (range 20)),
   :val (map (fn* [p1__201303#] (- p1__201303# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__201304#] (* (long p1__201304#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__201305#] (+ 18.0 (* 4.0 (Math/sin (* p1__201305# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__201306#] (+ 20.0 (* 5.0 (Math/sin (* p1__201306# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__201307#] (re-find #":\d\d" p1__201307#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__201308#] (* (long p1__201308#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__201309#] (+ 100 (* 50 (Math/sin (* p1__201309# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__201310#] (str "cat-" p1__201310#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__201311#] (re-find #"sepal|petal" p1__201311#))]
