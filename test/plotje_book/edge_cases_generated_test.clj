...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__108344#] (keyword (str "cat-" p1__108344#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__108345#] (= "setosa" (p1__108345# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__108346#] (- p1__108346# 10)) (range 20)),
   :val (map (fn* [p1__108347#] (- p1__108347# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__108348#] (* (long p1__108348#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__108349#] (+ 18.0 (* 4.0 (Math/sin (* p1__108349# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__108350#] (+ 20.0 (* 5.0 (Math/sin (* p1__108350# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__108351#] (re-find #":\d\d" p1__108351#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__108352#] (* (long p1__108352#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__108353#] (+ 100 (* 50 (Math/sin (* p1__108353# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__108354#] (str "cat-" p1__108354#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__108355#] (re-find #"sepal|petal" p1__108355#))]
