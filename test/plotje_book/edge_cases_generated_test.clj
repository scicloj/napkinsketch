...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__76468#] (keyword (str "cat-" p1__76468#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__76469#] (= "setosa" (p1__76469# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__76470#] (- p1__76470# 10)) (range 20)),
   :val (map (fn* [p1__76471#] (- p1__76471# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__76472#] (* (long p1__76472#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__76473#] (+ 18.0 (* 4.0 (Math/sin (* p1__76473# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__76474#] (+ 20.0 (* 5.0 (Math/sin (* p1__76474# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__76475#] (re-find #":\d\d" p1__76475#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__76476#] (* (long p1__76476#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__76477#] (+ 100 (* 50 (Math/sin (* p1__76477# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__76478#] (str "cat-" p1__76478#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__76479#] (re-find #"sepal|petal" p1__76479#))]
