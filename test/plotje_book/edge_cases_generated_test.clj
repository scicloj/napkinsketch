...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__90461#] (keyword (str "cat-" p1__90461#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__90462#] (= "setosa" (p1__90462# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__90463#] (- p1__90463# 10)) (range 20)),
   :val (map (fn* [p1__90464#] (- p1__90464# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90465#] (* (long p1__90465#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__90466#] (+ 18.0 (* 4.0 (Math/sin (* p1__90466# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__90467#] (+ 20.0 (* 5.0 (Math/sin (* p1__90467# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__90468#] (re-find #":\d\d" p1__90468#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90469#] (* (long p1__90469#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__90470#] (+ 100 (* 50 (Math/sin (* p1__90470# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__90471#] (str "cat-" p1__90471#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__90472#] (re-find #"sepal|petal" p1__90472#))]
