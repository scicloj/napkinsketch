...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__89398#] (keyword (str "cat-" p1__89398#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__89399#] (= "setosa" (p1__89399# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__89400#] (- p1__89400# 10)) (range 20)),
   :val (map (fn* [p1__89401#] (- p1__89401# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89402#] (* (long p1__89402#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__89403#] (+ 18.0 (* 4.0 (Math/sin (* p1__89403# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__89404#] (+ 20.0 (* 5.0 (Math/sin (* p1__89404# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__89405#] (re-find #":\d\d" p1__89405#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89406#] (* (long p1__89406#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__89407#] (+ 100 (* 50 (Math/sin (* p1__89407# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__89408#] (str "cat-" p1__89408#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__89409#] (re-find #"sepal|petal" p1__89409#))]
