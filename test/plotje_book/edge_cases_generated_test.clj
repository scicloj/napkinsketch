...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__90179#] (keyword (str "cat-" p1__90179#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__90180#] (= "setosa" (p1__90180# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__90181#] (- p1__90181# 10)) (range 20)),
   :val (map (fn* [p1__90182#] (- p1__90182# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90183#] (* (long p1__90183#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__90184#] (+ 18.0 (* 4.0 (Math/sin (* p1__90184# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__90185#] (+ 20.0 (* 5.0 (Math/sin (* p1__90185# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__90186#] (re-find #":\d\d" p1__90186#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__90187#] (* (long p1__90187#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__90188#] (+ 100 (* 50 (Math/sin (* p1__90188# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__90189#] (str "cat-" p1__90189#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__90190#] (re-find #"sepal|petal" p1__90190#))]
