...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__109827#] (keyword (str "cat-" p1__109827#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__109828#] (= "setosa" (p1__109828# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__109829#] (- p1__109829# 10)) (range 20)),
   :val (map (fn* [p1__109830#] (- p1__109830# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__109831#] (* (long p1__109831#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__109832#] (+ 18.0 (* 4.0 (Math/sin (* p1__109832# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__109833#] (+ 20.0 (* 5.0 (Math/sin (* p1__109833# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__109834#] (re-find #":\d\d" p1__109834#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__109835#] (* (long p1__109835#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__109836#] (+ 100 (* 50 (Math/sin (* p1__109836# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__109837#] (str "cat-" p1__109837#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__109838#] (re-find #"sepal|petal" p1__109838#))]
