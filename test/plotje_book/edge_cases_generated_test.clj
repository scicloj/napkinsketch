...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__528664#] (keyword (str "cat-" p1__528664#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__528665#] (= "setosa" (p1__528665# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__528666#] (- p1__528666# 10)) (range 20)),
   :val (map (fn* [p1__528667#] (- p1__528667# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__528668#] (* (long p1__528668#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__528669#] (+ 18.0 (* 4.0 (Math/sin (* p1__528669# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__528670#] (+ 20.0 (* 5.0 (Math/sin (* p1__528670# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__528671#] (re-find #":\d\d" p1__528671#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__528672#] (* (long p1__528672#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__528673#] (+ 100 (* 50 (Math/sin (* p1__528673# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__528674#] (str "cat-" p1__528674#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__528675#] (re-find #"sepal|petal" p1__528675#))]
