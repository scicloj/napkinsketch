...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__209967#] (keyword (str "cat-" p1__209967#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__209968#] (= "setosa" (p1__209968# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__209969#] (- p1__209969# 10)) (range 20)),
   :val (map (fn* [p1__209970#] (- p1__209970# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__209971#] (* (long p1__209971#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__209972#] (+ 18.0 (* 4.0 (Math/sin (* p1__209972# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__209973#] (+ 20.0 (* 5.0 (Math/sin (* p1__209973# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__209974#] (re-find #":\d\d" p1__209974#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__209975#] (* (long p1__209975#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__209976#] (+ 100 (* 50 (Math/sin (* p1__209976# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__209977#] (str "cat-" p1__209977#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__209978#] (re-find #"sepal|petal" p1__209978#))]
