...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__97155#] (keyword (str "cat-" p1__97155#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__97156#] (= "setosa" (p1__97156# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__97157#] (- p1__97157# 10)) (range 20)),
   :val (map (fn* [p1__97158#] (- p1__97158# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__97159#] (* (long p1__97159#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__97160#] (+ 18.0 (* 4.0 (Math/sin (* p1__97160# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__97161#] (+ 20.0 (* 5.0 (Math/sin (* p1__97161# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__97162#] (re-find #":\d\d" p1__97162#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__97163#] (* (long p1__97163#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__97164#] (+ 100 (* 50 (Math/sin (* p1__97164# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__97165#] (str "cat-" p1__97165#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__97166#] (re-find #"sepal|petal" p1__97166#))]
