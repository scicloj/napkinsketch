...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__78073#] (keyword (str "cat-" p1__78073#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__78074#] (= "setosa" (p1__78074# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__78075#] (- p1__78075# 10)) (range 20)),
   :val (map (fn* [p1__78076#] (- p1__78076# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78077#] (* (long p1__78077#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__78078#] (+ 18.0 (* 4.0 (Math/sin (* p1__78078# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__78079#] (+ 20.0 (* 5.0 (Math/sin (* p1__78079# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__78080#] (re-find #":\d\d" p1__78080#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__78081#] (* (long p1__78081#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__78082#] (+ 100 (* 50 (Math/sin (* p1__78082# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__78083#] (str "cat-" p1__78083#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__78084#] (re-find #"sepal|petal" p1__78084#))]
