...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__83398#] (keyword (str "cat-" p1__83398#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__83399#] (= "setosa" (p1__83399# :species))))
...
(deftest
 t76_l313
 (is ((fn [v] (= 3 (:points (pj/svg-summary v)))) v75_l310)))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__83400#] (- p1__83400# 10)) (range 20)),
   :val (map (fn* [p1__83401#] (- p1__83401# 10.0)) (range 20))}
...
(deftest
 t79_l323
 (is ((fn [v] (= 20 (:points (pj/svg-summary v)))) v78_l317)))
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__83402#] (* (long p1__83402#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__83403#] (+ 18.0 (* 4.0 (Math/sin (* p1__83403# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__83404#] (+ 20.0 (* 5.0 (Math/sin (* p1__83404# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__83405#] (re-find #":\d\d" p1__83405#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__83406#] (* (long p1__83406#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__83407#] (+ 100 (* 50 (Math/sin (* p1__83407# 0.4)))))
    (range 20))}
...
(def
 v93_l387
 (->
  {:cat (map (fn* [p1__83408#] (str "cat-" p1__83408#)) (range 12)),
...
(deftest
 t94_l392
 (is ((fn [v] (pos? (:polygons (pj/svg-summary v)))) v93_l387)))
...
(deftest
 t103_l434
 (is ((fn [v] (= 100 (:points (pj/svg-summary v)))) v102_l430)))
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__83409#] (re-find #"sepal|petal" p1__83409#))]
...
(deftest t109_l464 (is ((fn [m] (string? m)) v108_l457)))
...
(deftest t112_l475 (is ((fn [m] (string? m)) v111_l468)))
...
(deftest
 t115_l487
 (is ((fn [m] (re-find #"not supported with polar" m)) v114_l479)))
...
(deftest
 t118_l499
 (is ((fn [m] (re-find #"must contain :boxes" m)) v117_l491)))
