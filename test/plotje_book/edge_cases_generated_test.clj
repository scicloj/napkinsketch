...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__496796#] (keyword (str "cat-" p1__496796#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__496797#] (= "setosa" (p1__496797# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__496798#] (- p1__496798# 10)) (range 20)),
   :val (map (fn* [p1__496799#] (- p1__496799# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__496800#] (* (long p1__496800#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__496801#] (+ 18.0 (* 4.0 (Math/sin (* p1__496801# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__496802#] (+ 20.0 (* 5.0 (Math/sin (* p1__496802# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__496803#] (re-find #":\d\d" p1__496803#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__496804#] (* (long p1__496804#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__496805#] (+ 100 (* 50 (Math/sin (* p1__496805# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__496806#] (str "cat-" p1__496806#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__496807#] (re-find #"sepal|petal" p1__496807#))]
