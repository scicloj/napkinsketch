...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__89695#] (keyword (str "cat-" p1__89695#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__89696#] (= "setosa" (p1__89696# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__89697#] (- p1__89697# 10)) (range 20)),
   :val (map (fn* [p1__89698#] (- p1__89698# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89699#] (* (long p1__89699#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__89700#] (+ 18.0 (* 4.0 (Math/sin (* p1__89700# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__89701#] (+ 20.0 (* 5.0 (Math/sin (* p1__89701# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__89702#] (re-find #":\d\d" p1__89702#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89703#] (* (long p1__89703#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__89704#] (+ 100 (* 50 (Math/sin (* p1__89704# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__89705#] (str "cat-" p1__89705#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__89706#] (re-find #"sepal|petal" p1__89706#))]
