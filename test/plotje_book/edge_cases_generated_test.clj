...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__230673#] (keyword (str "cat-" p1__230673#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__230674#] (= "setosa" (p1__230674# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__230675#] (- p1__230675# 10)) (range 20)),
   :val (map (fn* [p1__230676#] (- p1__230676# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__230677#] (* (long p1__230677#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__230678#] (+ 18.0 (* 4.0 (Math/sin (* p1__230678# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__230679#] (+ 20.0 (* 5.0 (Math/sin (* p1__230679# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__230680#] (re-find #":\d\d" p1__230680#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__230681#] (* (long p1__230681#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__230682#] (+ 100 (* 50 (Math/sin (* p1__230682# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__230683#] (str "cat-" p1__230683#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__230684#] (re-find #"sepal|petal" p1__230684#))]
