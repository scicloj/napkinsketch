...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__88659#] (keyword (str "cat-" p1__88659#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__88660#] (= "setosa" (p1__88660# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__88661#] (- p1__88661# 10)) (range 20)),
   :val (map (fn* [p1__88662#] (- p1__88662# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__88663#] (* (long p1__88663#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__88664#] (+ 18.0 (* 4.0 (Math/sin (* p1__88664# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__88665#] (+ 20.0 (* 5.0 (Math/sin (* p1__88665# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__88666#] (re-find #":\d\d" p1__88666#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__88667#] (* (long p1__88667#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__88668#] (+ 100 (* 50 (Math/sin (* p1__88668# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__88669#] (str "cat-" p1__88669#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__88670#] (re-find #"sepal|petal" p1__88670#))]
