...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__88644#] (keyword (str "cat-" p1__88644#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__88645#] (= "setosa" (p1__88645# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__88646#] (- p1__88646# 10)) (range 20)),
   :val (map (fn* [p1__88647#] (- p1__88647# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__88648#] (* (long p1__88648#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__88649#] (+ 18.0 (* 4.0 (Math/sin (* p1__88649# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__88650#] (+ 20.0 (* 5.0 (Math/sin (* p1__88650# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__88651#] (re-find #":\d\d" p1__88651#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__88652#] (* (long p1__88652#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__88653#] (+ 100 (* 50 (Math/sin (* p1__88653# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__88654#] (str "cat-" p1__88654#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__88655#] (re-find #"sepal|petal" p1__88655#))]
