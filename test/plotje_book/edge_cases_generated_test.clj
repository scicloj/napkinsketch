...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__238134#] (keyword (str "cat-" p1__238134#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__238135#] (= "setosa" (p1__238135# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__238136#] (- p1__238136# 10)) (range 20)),
   :val (map (fn* [p1__238137#] (- p1__238137# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__238138#] (* (long p1__238138#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__238139#] (+ 18.0 (* 4.0 (Math/sin (* p1__238139# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__238140#] (+ 20.0 (* 5.0 (Math/sin (* p1__238140# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__238141#] (re-find #":\d\d" p1__238141#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__238142#] (* (long p1__238142#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__238143#] (+ 100 (* 50 (Math/sin (* p1__238143# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__238144#] (str "cat-" p1__238144#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__238145#] (re-find #"sepal|petal" p1__238145#))]
