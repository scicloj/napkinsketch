...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__96915#] (keyword (str "cat-" p1__96915#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__96916#] (= "setosa" (p1__96916# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__96917#] (- p1__96917# 10)) (range 20)),
   :val (map (fn* [p1__96918#] (- p1__96918# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96919#] (* (long p1__96919#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__96920#] (+ 18.0 (* 4.0 (Math/sin (* p1__96920# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__96921#] (+ 20.0 (* 5.0 (Math/sin (* p1__96921# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__96922#] (re-find #":\d\d" p1__96922#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96923#] (* (long p1__96923#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__96924#] (+ 100 (* 50 (Math/sin (* p1__96924# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__96925#] (str "cat-" p1__96925#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__96926#] (re-find #"sepal|petal" p1__96926#))]
