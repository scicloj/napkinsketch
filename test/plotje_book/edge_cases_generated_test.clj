...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__189367#] (keyword (str "cat-" p1__189367#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__189368#] (= "setosa" (p1__189368# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__189369#] (- p1__189369# 10)) (range 20)),
   :val (map (fn* [p1__189370#] (- p1__189370# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__189371#] (* (long p1__189371#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__189372#] (+ 18.0 (* 4.0 (Math/sin (* p1__189372# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__189373#] (+ 20.0 (* 5.0 (Math/sin (* p1__189373# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__189374#] (re-find #":\d\d" p1__189374#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__189375#] (* (long p1__189375#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__189376#] (+ 100 (* 50 (Math/sin (* p1__189376# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__189377#] (str "cat-" p1__189377#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__189378#] (re-find #"sepal|petal" p1__189378#))]
