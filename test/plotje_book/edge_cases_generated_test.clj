...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__84502#] (keyword (str "cat-" p1__84502#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__84503#] (= "setosa" (p1__84503# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__84504#] (- p1__84504# 10)) (range 20)),
   :val (map (fn* [p1__84505#] (- p1__84505# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__84506#] (* (long p1__84506#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__84507#] (+ 18.0 (* 4.0 (Math/sin (* p1__84507# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__84508#] (+ 20.0 (* 5.0 (Math/sin (* p1__84508# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__84509#] (re-find #":\d\d" p1__84509#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__84510#] (* (long p1__84510#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__84511#] (+ 100 (* 50 (Math/sin (* p1__84511# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__84512#] (str "cat-" p1__84512#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__84513#] (re-find #"sepal|petal" p1__84513#))]
