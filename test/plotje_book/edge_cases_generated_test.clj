...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__131544#] (keyword (str "cat-" p1__131544#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__131545#] (= "setosa" (p1__131545# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__131546#] (- p1__131546# 10)) (range 20)),
   :val (map (fn* [p1__131547#] (- p1__131547# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__131548#] (* (long p1__131548#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__131549#] (+ 18.0 (* 4.0 (Math/sin (* p1__131549# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__131550#] (+ 20.0 (* 5.0 (Math/sin (* p1__131550# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__131551#] (re-find #":\d\d" p1__131551#))
       (:texts s)))))
   v87_l357)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__131552#] (* (long p1__131552#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__131553#] (+ 100 (* 50 (Math/sin (* p1__131553# 0.4)))))
    (range 20))}
...
(def
 v93_l388
 (->
  {:cat (map (fn* [p1__131554#] (str "cat-" p1__131554#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__131555#] (re-find #"sepal|petal" p1__131555#))]
