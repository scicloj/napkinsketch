...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__89047#] (keyword (str "cat-" p1__89047#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__89048#] (= "setosa" (p1__89048# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__89049#] (- p1__89049# 10)) (range 20)),
   :val (map (fn* [p1__89050#] (- p1__89050# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89051#] (* (long p1__89051#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__89052#] (+ 18.0 (* 4.0 (Math/sin (* p1__89052# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__89053#] (+ 20.0 (* 5.0 (Math/sin (* p1__89053# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__89054#] (re-find #":\d\d" p1__89054#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__89055#] (* (long p1__89055#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__89056#] (+ 100 (* 50 (Math/sin (* p1__89056# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__89057#] (str "cat-" p1__89057#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__89058#] (re-find #"sepal|petal" p1__89058#))]
