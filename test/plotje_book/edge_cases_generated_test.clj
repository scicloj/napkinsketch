...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__565466#] (keyword (str "cat-" p1__565466#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__565467#] (= "setosa" (p1__565467# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__565468#] (- p1__565468# 10)) (range 20)),
   :val (map (fn* [p1__565469#] (- p1__565469# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__565470#] (* (long p1__565470#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__565471#] (+ 18.0 (* 4.0 (Math/sin (* p1__565471# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__565472#] (+ 20.0 (* 5.0 (Math/sin (* p1__565472# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__565473#] (re-find #":\d\d" p1__565473#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__565474#] (* (long p1__565474#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__565475#] (+ 100 (* 50 (Math/sin (* p1__565475# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__565476#] (str "cat-" p1__565476#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__565477#] (re-find #"sepal|petal" p1__565477#))]
