...
(def
 ...
 (->
  (let
   ...
   {:category
    (map
     (fn* [p1__96133#] (keyword (str "cat-" p1__96133#)))
     (range 12)),
...
(def
 ...
 (->
  (rdatasets/datasets-iris)
  (tc/select-rows
   (fn* [p1__96134#] (= "setosa" (p1__96134# :species))))
...
(def
 ...
 (->
  {:x (range 20),
   :y (map (fn* [p1__96135#] (- p1__96135# 10)) (range 20)),
   :val (map (fn* [p1__96136#] (- p1__96136# 10.0)) (range 20))}
 ...
 (->
  {:time
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96137#] (* (long p1__96137#) 15)) (range 24))
    :minutes),
   :value
   (map
    (fn* [p1__96138#] (+ 18.0 (* 4.0 (Math/sin (* p1__96138# 0.3)))))
    (range 24))}
...
(def
 ...
 (->
  {:time
   ...
   :temp
   (map
    (fn* [p1__96139#] (+ 20.0 (* 5.0 (Math/sin (* p1__96139# 0.5)))))
    (range 12))}
  ...
  ((fn
    ...
    (let
     ...
     (and
      ...
      (= 1 (:lines s))
      (some
       (fn* [p1__96140#] (re-find #":\d\d" p1__96140#))
       (:texts s)))))
   v87_l355)))
 ...
 (->
  {:date
   (dt-dt/plus-temporal-amount
    ...
    (map (fn* [p1__96141#] (* (long p1__96141#) 120)) (range 20))
    :days),
   :value
   (map
    (fn* [p1__96142#] (+ 100 (* 50 (Math/sin (* p1__96142# 0.4)))))
    (range 20))}
...
(def
 v93_l384
 (->
  {:cat (map (fn* [p1__96143#] (str "cat-" p1__96143#)) (range 12)),
  ...
  ((fn
    ...
    (let
     [s
      ...
      (:texts s)
      col-label?
      (fn* [p1__96144#] (re-find #"sepal|petal" p1__96144#))]
