...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89504#] (= 50 (:n-points p1__89504#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89505#] (< (:lo p1__89505#) (:hi p1__89505#)))
      bars)
     (every? (fn* [p1__89506#] (pos? (:count p1__89506#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89507#] (Math/sin (* p1__89507# 0.3))) (range 30))}))
