...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89678#] (= 50 (:n-points p1__89678#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89679#] (< (:lo p1__89679#) (:hi p1__89679#)))
      bars)
     (every? (fn* [p1__89680#] (pos? (:count p1__89680#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89681#] (Math/sin (* p1__89681# 0.3))) (range 30))}))
