...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__496153#] (= 50 (:n-points p1__496153#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__496154#] (< (:lo p1__496154#) (:hi p1__496154#)))
      bars)
     (every? (fn* [p1__496155#] (pos? (:count p1__496155#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__496156#] (Math/sin (* p1__496156# 0.3)))
    (range 30))}))
