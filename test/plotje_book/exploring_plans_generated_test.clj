...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__86422#] (= 50 (:n-points p1__86422#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__86423#] (< (:lo p1__86423#) (:hi p1__86423#)))
      bars)
     (every? (fn* [p1__86424#] (pos? (:count p1__86424#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__86425#] (Math/sin (* p1__86425# 0.3))) (range 30))}))
