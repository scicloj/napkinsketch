...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__124024#] (= 50 (:n-points p1__124024#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__124025#] (< (:lo p1__124025#) (:hi p1__124025#)))
      bars)
     (every? (fn* [p1__124026#] (pos? (:count p1__124026#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__124027#] (Math/sin (* p1__124027# 0.3)))
    (range 30))}))
