...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__82280#] (= 50 (:n-points p1__82280#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__82281#] (< (:lo p1__82281#) (:hi p1__82281#)))
      bars)
     (every? (fn* [p1__82282#] (pos? (:count p1__82282#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__82283#] (Math/sin (* p1__82283# 0.3))) (range 30))}))
