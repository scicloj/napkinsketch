...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__129175#] (= 50 (:n-points p1__129175#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__129176#] (< (:lo p1__129176#) (:hi p1__129176#)))
      bars)
     (every? (fn* [p1__129177#] (pos? (:count p1__129177#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__129178#] (Math/sin (* p1__129178# 0.3)))
    (range 30))}))
