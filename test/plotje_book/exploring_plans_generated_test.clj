...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__83859#] (= 50 (:n-points p1__83859#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__83860#] (< (:lo p1__83860#) (:hi p1__83860#)))
      bars)
     (every? (fn* [p1__83861#] (pos? (:count p1__83861#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__83862#] (Math/sin (* p1__83862# 0.3))) (range 30))}))
