...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__131167#] (= 50 (:n-points p1__131167#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__131168#] (< (:lo p1__131168#) (:hi p1__131168#)))
      bars)
     (every? (fn* [p1__131169#] (pos? (:count p1__131169#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__131170#] (Math/sin (* p1__131170# 0.3)))
    (range 30))}))
