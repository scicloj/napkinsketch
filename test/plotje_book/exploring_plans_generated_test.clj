...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__82257#] (= 50 (:n-points p1__82257#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__82258#] (< (:lo p1__82258#) (:hi p1__82258#)))
      bars)
     (every? (fn* [p1__82259#] (pos? (:count p1__82259#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__82260#] (Math/sin (* p1__82260# 0.3))) (range 30))}))
