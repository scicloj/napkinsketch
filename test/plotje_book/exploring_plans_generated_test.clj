...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__188724#] (= 50 (:n-points p1__188724#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__188725#] (< (:lo p1__188725#) (:hi p1__188725#)))
      bars)
     (every? (fn* [p1__188726#] (pos? (:count p1__188726#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__188727#] (Math/sin (* p1__188727# 0.3)))
    (range 30))}))
