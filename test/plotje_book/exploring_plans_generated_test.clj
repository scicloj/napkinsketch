...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__96238#] (= 50 (:n-points p1__96238#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__96239#] (< (:lo p1__96239#) (:hi p1__96239#)))
      bars)
     (every? (fn* [p1__96240#] (pos? (:count p1__96240#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__96241#] (Math/sin (* p1__96241# 0.3))) (range 30))}))
