...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__75825#] (= 50 (:n-points p1__75825#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__75826#] (< (:lo p1__75826#) (:hi p1__75826#)))
      bars)
     (every? (fn* [p1__75827#] (pos? (:count p1__75827#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__75828#] (Math/sin (* p1__75828# 0.3))) (range 30))}))
