...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__237471#] (= 50 (:n-points p1__237471#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__237472#] (< (:lo p1__237472#) (:hi p1__237472#)))
      bars)
     (every? (fn* [p1__237473#] (pos? (:count p1__237473#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__237474#] (Math/sin (* p1__237474# 0.3)))
    (range 30))}))
