...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87967#] (= 50 (:n-points p1__87967#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87968#] (< (:lo p1__87968#) (:hi p1__87968#)))
      bars)
     (every? (fn* [p1__87969#] (pos? (:count p1__87969#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87970#] (Math/sin (* p1__87970# 0.3))) (range 30))}))
