...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__101603#] (= 50 (:n-points p1__101603#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__101604#] (< (:lo p1__101604#) (:hi p1__101604#)))
      bars)
     (every? (fn* [p1__101605#] (pos? (:count p1__101605#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__101606#] (Math/sin (* p1__101606# 0.3)))
    (range 30))}))
