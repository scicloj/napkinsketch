...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__77433#] (= 50 (:n-points p1__77433#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__77434#] (< (:lo p1__77434#) (:hi p1__77434#)))
      bars)
     (every? (fn* [p1__77435#] (pos? (:count p1__77435#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__77436#] (Math/sin (* p1__77436# 0.3))) (range 30))}))
