...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__200657#] (= 50 (:n-points p1__200657#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__200658#] (< (:lo p1__200658#) (:hi p1__200658#)))
      bars)
     (every? (fn* [p1__200659#] (pos? (:count p1__200659#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__200660#] (Math/sin (* p1__200660# 0.3)))
    (range 30))}))
