...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89032#] (= 50 (:n-points p1__89032#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89033#] (< (:lo p1__89033#) (:hi p1__89033#)))
      bars)
     (every? (fn* [p1__89034#] (pos? (:count p1__89034#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89035#] (Math/sin (* p1__89035# 0.3))) (range 30))}))
