...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__95470#] (= 50 (:n-points p1__95470#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__95471#] (< (:lo p1__95471#) (:hi p1__95471#)))
      bars)
     (every? (fn* [p1__95472#] (pos? (:count p1__95472#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__95473#] (Math/sin (* p1__95473# 0.3))) (range 30))}))
