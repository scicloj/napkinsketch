...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__96492#] (= 50 (:n-points p1__96492#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__96493#] (< (:lo p1__96493#) (:hi p1__96493#)))
      bars)
     (every? (fn* [p1__96494#] (pos? (:count p1__96494#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__96495#] (Math/sin (* p1__96495# 0.3))) (range 30))}))
