...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88370#] (= 50 (:n-points p1__88370#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88371#] (< (:lo p1__88371#) (:hi p1__88371#)))
      bars)
     (every? (fn* [p1__88372#] (pos? (:count p1__88372#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88373#] (Math/sin (* p1__88373# 0.3))) (range 30))}))
