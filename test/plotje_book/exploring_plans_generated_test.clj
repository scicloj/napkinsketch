...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87119#] (= 50 (:n-points p1__87119#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87120#] (< (:lo p1__87120#) (:hi p1__87120#)))
      bars)
     (every? (fn* [p1__87121#] (pos? (:count p1__87121#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87122#] (Math/sin (* p1__87122# 0.3))) (range 30))}))
