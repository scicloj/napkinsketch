...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__230010#] (= 50 (:n-points p1__230010#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__230011#] (< (:lo p1__230011#) (:hi p1__230011#)))
      bars)
     (every? (fn* [p1__230012#] (pos? (:count p1__230012#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__230013#] (Math/sin (* p1__230013# 0.3)))
    (range 30))}))
