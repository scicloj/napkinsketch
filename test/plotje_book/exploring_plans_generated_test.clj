...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__528019#] (= 50 (:n-points p1__528019#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__528020#] (< (:lo p1__528020#) (:hi p1__528020#)))
      bars)
     (every? (fn* [p1__528021#] (pos? (:count p1__528021#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__528022#] (Math/sin (* p1__528022# 0.3)))
    (range 30))}))
