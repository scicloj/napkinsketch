...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88735#] (= 50 (:n-points p1__88735#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88736#] (< (:lo p1__88736#) (:hi p1__88736#)))
      bars)
     (every? (fn* [p1__88737#] (pos? (:count p1__88737#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88738#] (Math/sin (* p1__88738# 0.3))) (range 30))}))
