...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89180#] (= 50 (:n-points p1__89180#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89181#] (< (:lo p1__89181#) (:hi p1__89181#)))
      bars)
     (every? (fn* [p1__89182#] (pos? (:count p1__89182#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89183#] (Math/sin (* p1__89183# 0.3))) (range 30))}))
