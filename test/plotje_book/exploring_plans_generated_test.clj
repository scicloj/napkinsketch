...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__564821#] (= 50 (:n-points p1__564821#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__564822#] (< (:lo p1__564822#) (:hi p1__564822#)))
      bars)
     (every? (fn* [p1__564823#] (pos? (:count p1__564823#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__564824#] (Math/sin (* p1__564824# 0.3)))
    (range 30))}))
