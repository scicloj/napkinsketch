...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__138718#] (= 50 (:n-points p1__138718#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__138719#] (< (:lo p1__138719#) (:hi p1__138719#)))
      bars)
     (every? (fn* [p1__138720#] (pos? (:count p1__138720#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__138721#] (Math/sin (* p1__138721# 0.3)))
    (range 30))}))
