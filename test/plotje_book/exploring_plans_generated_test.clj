...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__209318#] (= 50 (:n-points p1__209318#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__209319#] (< (:lo p1__209319#) (:hi p1__209319#)))
      bars)
     (every? (fn* [p1__209320#] (pos? (:count p1__209320#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__209321#] (Math/sin (* p1__209321# 0.3)))
    (range 30))}))
