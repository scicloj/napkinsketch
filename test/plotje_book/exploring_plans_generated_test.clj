...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__93134#] (= 50 (:n-points p1__93134#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__93135#] (< (:lo p1__93135#) (:hi p1__93135#)))
      bars)
     (every? (fn* [p1__93136#] (pos? (:count p1__93136#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__93137#] (Math/sin (* p1__93137# 0.3))) (range 30))}))
