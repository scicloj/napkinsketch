...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87766#] (= 50 (:n-points p1__87766#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87767#] (< (:lo p1__87767#) (:hi p1__87767#)))
      bars)
     (every? (fn* [p1__87768#] (pos? (:count p1__87768#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87769#] (Math/sin (* p1__87769# 0.3))) (range 30))}))
