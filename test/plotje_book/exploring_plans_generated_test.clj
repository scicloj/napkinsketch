...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__117472#] (= 50 (:n-points p1__117472#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__117473#] (< (:lo p1__117473#) (:hi p1__117473#)))
      bars)
     (every? (fn* [p1__117474#] (pos? (:count p1__117474#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__117475#] (Math/sin (* p1__117475# 0.3)))
    (range 30))}))
