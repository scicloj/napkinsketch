...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__109184#] (= 50 (:n-points p1__109184#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__109185#] (< (:lo p1__109185#) (:hi p1__109185#)))
      bars)
     (every? (fn* [p1__109186#] (pos? (:count p1__109186#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__109187#] (Math/sin (* p1__109187# 0.3)))
    (range 30))}))
