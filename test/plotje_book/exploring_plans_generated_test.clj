...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__107681#] (= 50 (:n-points p1__107681#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__107682#] (< (:lo p1__107682#) (:hi p1__107682#)))
      bars)
     (every? (fn* [p1__107683#] (pos? (:count p1__107683#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__107684#] (Math/sin (* p1__107684# 0.3)))
    (range 30))}))
