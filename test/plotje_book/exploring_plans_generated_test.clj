...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__103278#] (= 50 (:n-points p1__103278#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__103279#] (< (:lo p1__103279#) (:hi p1__103279#)))
      bars)
     (every? (fn* [p1__103280#] (pos? (:count p1__103280#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__103281#] (Math/sin (* p1__103281# 0.3)))
    (range 30))}))
