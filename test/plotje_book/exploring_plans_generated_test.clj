...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__121384#] (= 50 (:n-points p1__121384#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__121385#] (< (:lo p1__121385#) (:hi p1__121385#)))
      bars)
     (every? (fn* [p1__121386#] (pos? (:count p1__121386#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map
    (fn* [p1__121387#] (Math/sin (* p1__121387# 0.3)))
    (range 30))}))
