...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87794#] (= 50 (:n-points p1__87794#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87795#] (< (:lo p1__87795#) (:hi p1__87795#)))
      bars)
     (every? (fn* [p1__87796#] (pos? (:count p1__87796#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87797#] (Math/sin (* p1__87797# 0.3))) (range 30))}))
