...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87232#] (= 50 (:n-points p1__87232#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87233#] (< (:lo p1__87233#) (:hi p1__87233#)))
      bars)
     (every? (fn* [p1__87234#] (pos? (:count p1__87234#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87235#] (Math/sin (* p1__87235# 0.3))) (range 30))}))
