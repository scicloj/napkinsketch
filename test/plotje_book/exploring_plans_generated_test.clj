...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__87982#] (= 50 (:n-points p1__87982#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__87983#] (< (:lo p1__87983#) (:hi p1__87983#)))
      bars)
     (every? (fn* [p1__87984#] (pos? (:count p1__87984#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__87985#] (Math/sin (* p1__87985# 0.3))) (range 30))}))
