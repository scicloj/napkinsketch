...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__85625#] (= 50 (:n-points p1__85625#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__85626#] (< (:lo p1__85626#) (:hi p1__85626#)))
      bars)
     (every? (fn* [p1__85627#] (pos? (:count p1__85627#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__85628#] (Math/sin (* p1__85628# 0.3))) (range 30))}))
