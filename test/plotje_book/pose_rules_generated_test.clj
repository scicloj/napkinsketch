...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__72596#] (dissoc p1__72596# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__72597#] (= 2 (count (:poses p1__72597#))))
      (:poses pose))))
   v63_l377)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__72598#]
        (when (= :rule-h (:layer-type p1__72598#)) p1__72598#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__72599#]
        (get-in p1__72599# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__72600#] (= 2 (count (:poses p1__72600#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v170_l1062)))
