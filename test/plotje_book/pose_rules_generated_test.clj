...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__86029#] (dissoc p1__86029# :data))))
   (:poses pose)
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__86030#]
        (when (= :rule-h (:layer-type p1__86030#)) p1__86030#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__86031#]
        (get-in p1__86031# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__86032#] (= 2 (count (:poses p1__86032#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v161_l1012)))
