...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__126236#] (dissoc p1__126236# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__126237#] (= 2 (count (:poses p1__126237#))))
      (:poses pose))))
   v63_l377)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__126238#]
        (when (= :rule-h (:layer-type p1__126238#)) p1__126238#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__126239#]
        (get-in p1__126239# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__126240#] (= 2 (count (:poses p1__126240#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v170_l1062)))
