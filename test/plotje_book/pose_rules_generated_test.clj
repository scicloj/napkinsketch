...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__82209#] (dissoc p1__82209# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82210#] (= 2 (count (:poses p1__82210#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__82211#]
        (when (= :rule-h (:layer-type p1__82211#)) p1__82211#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__82212#]
        (get-in p1__82212# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__82213#] (= 2 (count (:poses p1__82213#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v175_l1071)))
