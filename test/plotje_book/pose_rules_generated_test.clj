...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__112461#] (dissoc p1__112461# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__112462#] (= 2 (count (:poses p1__112462#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__112463#]
        (when (= :rule-h (:layer-type p1__112463#)) p1__112463#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__112464#]
        (get-in p1__112464# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__112465#] (= 2 (count (:poses p1__112465#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v175_l1071)))
