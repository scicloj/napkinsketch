...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__80633#] (dissoc p1__80633# :data))))
   (:poses fr)
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__80634#]
        (when (= :rule-h (:layer-type p1__80634#)) p1__80634#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__80635#]
        (get-in p1__80635# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses fr)))
     (every?
      (fn* [p1__80636#] (= 2 (count (:poses p1__80636#))))
      (:poses fr))
     (= {:color :species} (:mapping fr))))
   v161_l1009)))
