...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__84162#] (dissoc p1__84162# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__84163#] (= 2 (count (:poses p1__84163#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__84164#]
        (when (= :rule-h (:layer-type p1__84164#)) p1__84164#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__84165#]
        (get-in p1__84165# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__84166#] (= 2 (count (:poses p1__84166#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v175_l1071)))
