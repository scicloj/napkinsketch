...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__83085#] (dissoc p1__83085# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__83086#] (= 2 (count (:poses p1__83086#))))
      (:poses pose))))
   v63_l378)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__83087#]
        (when (= :rule-h (:layer-type p1__83087#)) p1__83087#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__83088#]
        (get-in p1__83088# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__83089#] (= 2 (count (:poses p1__83089#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v170_l1064)))
