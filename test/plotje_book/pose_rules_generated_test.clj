...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__559883#] (dissoc p1__559883# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__559884#] (= 2 (count (:poses p1__559884#))))
      (:poses pose))))
   v63_l377)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__559885#]
        (when (= :rule-h (:layer-type p1__559885#)) p1__559885#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__559886#]
        (get-in p1__559886# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__559887#] (= 2 (count (:poses p1__559887#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v170_l1062)))
