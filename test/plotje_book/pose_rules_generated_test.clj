...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__83748#] (dissoc p1__83748# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__83749#] (= 2 (count (:poses p1__83749#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__83750#]
        (when (= :rule-h (:layer-type p1__83750#)) p1__83750#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__83751#]
        (get-in p1__83751# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__83752#] (= 2 (count (:poses p1__83752#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v175_l1071)))
