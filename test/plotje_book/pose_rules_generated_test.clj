...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__72153#] (dissoc p1__72153# :data))))
   (:poses fr)
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__72154#]
        (when (= :rule-h (:layer-type p1__72154#)) p1__72154#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__72155#]
        (get-in p1__72155# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses fr)))
     (every?
      (fn* [p1__72156#] (= 2 (count (:poses p1__72156#))))
      (:poses fr))
     (= {:color :species} (:mapping fr))))
   v161_l1011)))
