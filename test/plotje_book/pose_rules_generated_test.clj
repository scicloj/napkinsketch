...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__523087#] (dissoc p1__523087# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__523088#] (= 2 (count (:poses p1__523088#))))
      (:poses pose))))
   v63_l377)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__523089#]
        (when (= :rule-h (:layer-type p1__523089#)) p1__523089#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__523090#]
        (get-in p1__523090# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__523091#] (= 2 (count (:poses p1__523091#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v170_l1062)))
