...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__87769#] (dissoc p1__87769# :data))))
   (:poses pose)
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__87770#]
        (when (= :rule-h (:layer-type p1__87770#)) p1__87770#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__87771#]
        (get-in p1__87771# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__87772#] (= 2 (count (:poses p1__87772#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v161_l1012)))
