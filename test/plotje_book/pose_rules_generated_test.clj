...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__85269#] (dissoc p1__85269# :data))))
   (:poses fr)
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__85270#]
        (when (= :rule-h (:layer-type p1__85270#)) p1__85270#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__85271#]
        (get-in p1__85271# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses fr)))
     (every?
      (fn* [p1__85272#] (= 2 (count (:poses p1__85272#))))
      (:poses fr))
     (= {:color :species} (:mapping fr))))
   v161_l1011)))
