...
(def
 ...
 (defn
  ...
  (cond->
   ...
   (update
    :layers
    (partial mapv (fn* [p1__124157#] (dissoc p1__124157# :data))))
   (:poses pose)
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__124158#] (= 2 (count (:poses p1__124158#))))
      (:poses pose))))
   v76_l411)))
    ...
    (let
     [layers
      ...
      (some
       (fn*
        [p1__124159#]
        (when (= :rule-h (:layer-type p1__124159#)) p1__124159#))
       layers)]
    ...
    (let
     [sub-plots
      ...
      (mapv
       (fn*
        [p1__124160#]
        (get-in p1__124160# [:plan :panels 0 :x-scale :domain]))
       sub-plots)]
 ...
 (is
  ((fn
    ...
    (and
     ...
     (= 2 (count (:poses pose)))
     (every?
      (fn* [p1__124161#] (= 2 (count (:poses p1__124161#))))
      (:poses pose))
     (= {:color :species} (:mapping pose))))
   v175_l1071)))
