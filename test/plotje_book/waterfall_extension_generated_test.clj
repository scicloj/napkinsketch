  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__95998#] (nth waterfall-bars p1__95998#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__95999#] (nth waterfall-bars p1__95999#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__96000#] (= green (:color p1__96000#)))
       positive-bars)
      (every?
       (fn* [p1__96001#] (= red (:color p1__96001#)))
       negative-bars))))
   v17_l164)))
