  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__90044#] (nth waterfall-bars p1__90044#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__90045#] (nth waterfall-bars p1__90045#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__90046#] (= green (:color p1__90046#)))
       positive-bars)
      (every?
       (fn* [p1__90047#] (= red (:color p1__90047#)))
       negative-bars))))
   v17_l164)))
