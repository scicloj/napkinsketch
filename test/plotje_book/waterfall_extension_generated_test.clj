  ...
  ((fn
    ...
    (let
     [s
      ...
      positive-bars
      (mapv
       (fn* [p1__129793#] (nth waterfall-bars p1__129793#))
       [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__129794#] (nth waterfall-bars p1__129794#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__129795#] (= green (:color p1__129795#)))
       positive-bars)
      (every?
       (fn* [p1__129796#] (= red (:color p1__129796#)))
       negative-bars))))
   v17_l164)))
