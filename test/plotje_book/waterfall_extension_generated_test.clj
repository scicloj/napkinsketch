  ...
  ((fn
    ...
    (let
     [s
      ...
      positive-bars
      (mapv
       (fn* [p1__237999#] (nth waterfall-bars p1__237999#))
       [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__238000#] (nth waterfall-bars p1__238000#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__238001#] (= green (:color p1__238001#)))
       positive-bars)
      (every?
       (fn* [p1__238002#] (= red (:color p1__238002#)))
       negative-bars))))
   v17_l164)))
