  ...
  ((fn
    ...
    (let
     [s
      ...
      positive-bars
      (mapv
       (fn* [p1__230538#] (nth waterfall-bars p1__230538#))
       [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__230539#] (nth waterfall-bars p1__230539#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__230540#] (= green (:color p1__230540#)))
       positive-bars)
      (every?
       (fn* [p1__230541#] (= red (:color p1__230541#)))
       negative-bars))))
   v17_l164)))
