  ...
  ((fn
    ...
    (let
     [s
      ...
      positive-bars
      (mapv
       (fn* [p1__118014#] (nth waterfall-bars p1__118014#))
       [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__118015#] (nth waterfall-bars p1__118015#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__118016#] (= green (:color p1__118016#)))
       positive-bars)
      (every?
       (fn* [p1__118017#] (= red (:color p1__118017#)))
       negative-bars))))
   v17_l164)))
